        ...
        <Table>
          <TableBody>
            {refineRelationships.map((relationship) => {
              ...
              const isValue = !!value;
              let link = `/home/resource/${relationship.target_table_name}?filters=[{"id":"${relationship.target_column_name}","value":"${value}","variant":"text","operator":"eq","filterId":"${relationship.id}"}]`;
              ...
              if (!value) {
                ...
                link = `/home/resource/${relationship.source_table_name}?filters=[{"id":"${relationship.source_column_name}","value":"${value}","variant":"text","operator":"eq","filterId":"${relationship.id}"}]`;
              }
              return (
                <TableRow
                  key={relationship.id}
