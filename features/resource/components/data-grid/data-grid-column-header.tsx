...
import { memo, useCallback, type ComponentProps, type PointerEvent } from "react";
  ...
  return (
    <>
      <DropdownMenu modal={false}>
        <DropdownMenuTrigger
          className={cn(
            "bg-muted hover:bg-muted data-[state=open]:bg-muted flex size-full items-center justify-between gap-2 p-2 text-sm [&_svg]:size-4",
