...
BEGIN
    ...
    -- ==========================================
    -- WORKOUT SESSIONS (15 sessions)
    -- ==========================================
    INSERT INTO health_fitness.workout_sessions 
    (id, account_id, workout_plan_id, session_date, start_time, end_time, duration_minutes, 
    ...
    VALUES
    -- User 1 sessions
    (gen_random_uuid(), account1, workout_plan1, CURRENT_DATE - INTERVAL '10 days',
    ...
    -- User 2 sessions
    INSERT INTO health_fitness.workout_sessions VALUES
    (gen_random_uuid(), account2, workout_plan2, CURRENT_DATE - INTERVAL '7 days',
    ...
    -- User 3 sessions
    INSERT INTO health_fitness.workout_sessions VALUES
    (gen_random_uuid(), account3, workout_plan3, CURRENT_DATE - INTERVAL '8 days',
    ...
    -- ==========================================
    -- MEALS (15 meals across 3 days for different users)
    -- ==========================================
    INSERT INTO health_fitness.meals 
    (id, account_id, meal_date, meal_type, meal_time, location, notes)
    VALUES
    -- User 1 - Day 1
    (gen_random_uuid(), account1, CURRENT_DATE - INTERVAL '2 days', 'breakfast', '07:30', 'home', 'Post-workout meal')
    ...
    INSERT INTO health_fitness.meals VALUES
    -- User 1 - Day 2
    (gen_random_uuid(), account1, CURRENT_DATE - INTERVAL '1 day', 'breakfast', '07:00', 'home', NULL),
    (gen_random_uuid(), account1, CURRENT_DATE - INTERVAL '1 day', 'lunch', '12:00', 'restaurant', 'Business lunch'),
    (gen_random_uuid(), account1, CURRENT_DATE - INTERVAL '1 day', 'dinner', '18:30', 'home', NULL);
    
    -- User 2 - Day 1
    INSERT INTO health_fitness.meals VALUES
    (gen_random_uuid(), account2, CURRENT_DATE - INTERVAL '1 day', 'breakfast', '08:00', 'home', 'Big breakfast for bulking')
    RETURNING id INTO meal5;
    
    INSERT INTO health_fitness.meals VALUES
    (gen_random_uuid(), account2, CURRENT_DATE - INTERVAL '1 day', 'pre_workout', '16:00', 'home', 'Pre-workout fuel'),
    (gen_random_uuid(), account2, CURRENT_DATE - INTERVAL '1 day', 'post_workout', '18:30', 'gym', 'Protein shake'),
    (gen_random_uuid(), account2, CURRENT_DATE - INTERVAL '1 day', 'dinner', '20:00', 'home', 'High protein dinner'),
    ...
    -- ==========================================
    -- DAILY SUMMARIES (Generate summaries for recent days)
    -- ==========================================
    ...
    (account3, CURRENT_DATE, 1800, 1900, -100,
     90, 200, 70, 28, 2000, 45, 7000, 60, 7.3, 8, 69.5)
