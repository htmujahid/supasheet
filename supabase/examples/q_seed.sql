...
values
  ...
  (
    ...
    'INT-INSP-002',
    'Final Inspection Procedure (legacy)',
    '1.0',
    'internal',
    'superseded',
  ...
  (
    ...
    'CUST-ACME-SPEC-01',
    'Acme — Custom Headphone Acoustic Spec',
    '1.2',
    'customer_spec',
    'active',
...
set
  superseded_by_id = '70000000-0000-0000-0000-000000000003'
where
...
values
  ...
  (
    ...
    array['incoming', 'conditional'],
    '#fb923c',
    'Use-as-is approved by QA.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '34 days',
    current_timestamp - interval '34 days'
  ),
  ...
  (
    ...
    'INSP-2026-0003',
    'In-process — Headphone WO-0001 mid-run',
    'in_process',
    'passed',
    '70000000-0000-0000-0000-000000000005',
    'work_order',
  ...
  (
    ...
    array['final', 'failed'],
    '#ef4444',
    'Rejected units routed to scrap.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '35 days',
    current_timestamp - interval '35 days'
  ),
  ...
  (
    ...
    'INSP-2026-0005',
    'Final — Cable WO-0002 first sub-batch',
    'final',
    'failed',
    '70000000-0000-0000-0000-000000000003',
    'work_order',
    ...
    array['final', 'failed', 'solder'],
    '#dc2626',
    'Solder station temp recalibrated mid-run.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '24 days',
    current_timestamp - interval '24 days'
  ),
  ...
  (
    ...
    'INSP-2026-0006',
    'First Article — Leather bag WO-0003',
    'first_article',
    'passed',
    '70000000-0000-0000-0000-000000000003',
    'work_order',
  ...
  (
    ...
    'INSP-2026-0007',
    'Supplier audit — Wayne Industrial',
    'supplier_audit',
    'conditional',
    '70000000-0000-0000-0000-000000000001',
    'supplier',
  ...
  (
    ...
    'INSP-2026-0008',
    'Final — Bag WO-0003 outputs (pending)',
    'final',
    'pending',
    '70000000-0000-0000-0000-000000000003',
    'work_order',
...
values
  ...
  (
    '70000000-0000-0000-0000-200000000001',
    '70000000-0000-0000-0000-100000000001',
    10,
    'Driver impedance',
    'LCR meter',
  ...
  (
    '70000000-0000-0000-0000-200000000002',
    '70000000-0000-0000-0000-100000000001',
    20,
    'SPL output',
    'Acoustic rig A',
  ...
  (
    '70000000-0000-0000-0000-200000000003',
    '70000000-0000-0000-0000-100000000001',
    30,
    'Visual / cosmetic',
    'Visual',
  ...
  (
    '70000000-0000-0000-0000-200000000004',
    '70000000-0000-0000-0000-100000000002',
    10,
    'Wire continuity',
    'Continuity tester',
  ...
  (
    '70000000-0000-0000-0000-200000000005',
    '70000000-0000-0000-0000-100000000002',
    20,
    'Jacket condition',
    'Visual',
    ...
    null,
    'fail',
    '1 of 25 units jacket damage.',
    current_timestamp - interval '34 days'
  ),
  (
    '70000000-0000-0000-0000-200000000006',
    '70000000-0000-0000-0000-100000000002',
    30,
    'Length',
    'Tape',
  ...
  (
    '70000000-0000-0000-0000-200000000007',
    '70000000-0000-0000-0000-100000000004',
    10,
    'L/R balance',
    'Acoustic rig A',
  ...
  (
    '70000000-0000-0000-0000-200000000008',
    '70000000-0000-0000-0000-100000000004',
    20,
    'Battery runtime',
    'Bench test',
  ...
  (
    '70000000-0000-0000-0000-200000000009',
    '70000000-0000-0000-0000-100000000004',
    30,
    'Bluetooth pairing',
    'Manual',
  ...
  (
    '70000000-0000-0000-0000-20000000000a',
    '70000000-0000-0000-0000-100000000005',
    10,
    'USB-C functional',
    'Functional rig',
  ...
  (
    '70000000-0000-0000-0000-20000000000b',
    '70000000-0000-0000-0000-100000000005',
    20,
    'Continuity',
    'Continuity tester',
  ...
  (
    '70000000-0000-0000-0000-20000000000c',
    '70000000-0000-0000-0000-100000000006',
    10,
    'Stitch quality',
    'Visual + tug',
  ...
  (
    '70000000-0000-0000-0000-20000000000d',
    '70000000-0000-0000-0000-100000000006',
    20,
    'Hardware fit',
    'Manual',
  ...
  (
    '70000000-0000-0000-0000-20000000000e',
    '70000000-0000-0000-0000-100000000006',
    30,
    'Color match',
    'Visual',
...
values
  ...
  (
    ...
    'NCR-2026-0001',
    'L/R imbalance on headphone batch',
    'minor',
    'closed',
    'scrap',
    '70000000-0000-0000-0000-100000000004',
  ...
  (
    ...
    'NCR-2026-0002',
    'Cold solder joints on cable batch',
    'major',
    'investigating',
    'rework',
    '70000000-0000-0000-0000-100000000005',
    ...
    array['rework', 'solder'],
    '#fb923c',
    'Affected units pulled for rework.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '24 days',
  ...
  (
    ...
    'NCR-2026-0003',
    'Damaged jacket on incoming USB-C wire',
    'minor',
    'open',
    'use_as_is',
    '70000000-0000-0000-0000-100000000002',
  ...
  (
    ...
    'NCR-2026-0004',
    'Suspect Wayne dock board batch',
    'critical',
    'investigating',
    'return_to_supplier',
    null,
    ...
    null,
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    array['critical', 'supplier', 'escalated'],
    '#dc2626',
  ...
  (
    ...
    'NCR-2026-0005',
    'Bag stitching loose on first run unit',
    'minor',
    'resolved',
    'rework',
    null,
  ...
  (
    ...
    'NCR-2026-0006',
    'Suspected paint defect on bag (false alarm)',
    'minor',
    'cancelled',
    null,
    null,
...
values
  ...
  (
    ...
    'CAPA-2026-0001',
    'Update driver mount adhesive process',
    'corrective',
    'closed',
    'medium',
    '70000000-0000-0000-0000-300000000001',
  ...
  (
    ...
    'CAPA-2026-0002',
    'Solder station calibration program',
    'corrective',
    'in_progress',
    'high',
    '70000000-0000-0000-0000-300000000002',
  ...
  (
    ...
    'CAPA-2026-0003',
    'Wayne Industrial — supplier corrective action',
    'corrective',
    'open',
    'critical',
    '70000000-0000-0000-0000-300000000004',
  ...
  (
    ...
    'CAPA-2026-0005',
    'Inspection bench lighting upgrade (cancelled)',
    'preventive',
    'cancelled',
    'low',
    '70000000-0000-0000-0000-300000000006',
...
values
  ...
  (
    ...
    'AUD-2026-0003',
    'Supplier audit — Globex Components',
    'supplier',
    'in_progress',
    '70000000-0000-0000-0000-000000000001',
    'Globex Components',
  ...
  (
    ...
    'AUD-2026-0004',
    'Regulatory inspection — incoming materials',
    'regulatory',
    'planned',
    '70000000-0000-0000-0000-000000000002',
    'QA + Operations',
...
values
  ...
  (
    ...
    'closed',
    '7.5.3',
    'Document control — outdated SOP referenced in training',
  ...
  (
    ...
    'closed',
    '8.5.1',
    'Inspection log — sporadic missing initials',
  ...
  (
    ...
    'in_progress',
    '8.7',
    'Non-conforming product handling — segregation gap',
  ...
  (
    ...
    'open',
    '7.1.5.2',
    'Calibration — solder station overdue',
    ...
    current_date - interval '3 days',
    null,
    array['major', 'calibration', 'overdue'],
    'Overdue close.',
    current_timestamp - interval '20 days',
    current_timestamp - interval '3 days'
  ),
  ...
  (
    ...
    'open',
    '8.4.2',
    'Cosmetic packaging variability',
  ...
  (
    ...
    'open',
    '8.4.3',
    'Incoming COA missing for last shipment',
  ...
  (
    ...
    'resolved',
    '8.5',
    'Suspected counterfeit components reported by supplier',
  ...
  (
    ...
    'verified',
    '6.1',
    'Risk register — no review record for Q1',
...
values
  ...
  (
    ...
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '530 days',
    current_timestamp - interval '30 days'
  ),
  (
    ...
    null,
    'active',
    'Internal — backed by component CoAs.',
  ...
  (
    ...
    'CERT-CE-2026-001',
    'CE Marking — Product Family Pro',
    null,
    'pending',
    'Notified Body 1234',
    'ELC-WHP-001 product family.',
    null,
...
values
  ...
  (
    ...
    'COMP-2026-0001',
    'Headphone arrived with imbalanced channels',
    'medium',
    'closed',
    'Acme Corporation',
  ...
  (
    ...
    'COMP-2026-0002',
    'USB-C cable failed within 2 weeks',
    'high',
    'investigating',
    'Initech Software',
    ...
    '70000000-0000-0000-0000-400000000002',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    array['investigating', 'escalated'],
    '#fb923c',
    'Escalated — possible solder defect.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '14 days',
    current_timestamp - interval '4 days'
  ),
  ...
  (
    ...
    'COMP-2026-0003',
    'Dock burned out after 1 hour use',
    'critical',
    'received',
    'Stark Industries',
    'eng-support@stark.example.com',
    'HW-DOC-002',
    ...
    null,
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b4',
    array['critical', 'safety'],
    '#dc2626',
    'Tied to suspect Wayne board batch.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b4',
    current_timestamp - interval '2 days',
    current_timestamp - interval '1 day'
  ),
  ...
  (
    ...
    'COMP-2026-0004',
    'Bag stitching loose on receipt',
    'low',
    'resolved',
    'Wayne Enterprises',
    'shipping@wayne.example.com',
    'PRM-BAG-001',
    'Leather Laptop Bag',
    'LOT-BAG-2026-05A',
    null,
  ...
  (
    ...
    'COMP-2026-0005',
    'Headphone "broken after 6 months" (out of warranty / accidental damage)',
    'low',
    'rejected',
    'Lisa Anderson',
    ...
    null,
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    array['rejected', 'out-of-warranty'],
    '#94a3b8',
    null,
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '15 days',
