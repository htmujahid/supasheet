...
create type quality.inspection_type as enum ('incoming', 'in_process', 'final', 'first_article', 'supplier_audit');
create type quality.inspection_result as enum ('pending', 'passed', 'failed', 'conditional', 'cancelled');
...
create type quality.ncr_status as enum ('open', 'investigating', 'resolved', 'closed', 'cancelled');
create type quality.ncr_disposition as enum ('rework', 'scrap', 'use_as_is', 'return_to_supplier', 'rework_under_concession');
create type quality.capa_type as enum ('corrective', 'preventive');
create type quality.capa_status as enum ('open', 'in_progress', 'verification', 'closed', 'cancelled');
...
create type quality.audit_status as enum ('planned', 'in_progress', 'completed', 'closed', 'cancelled');
create type quality.finding_severity as enum ('observation', 'minor', 'major', 'critical');
create type quality.finding_status as enum ('open', 'in_progress', 'resolved', 'verified', 'closed');
create type quality.certification_status as enum ('pending', 'active', 'expiring_soon', 'expired', 'suspended');
create type quality.complaint_severity as enum ('low', 'medium', 'high', 'critical');
create type quality.complaint_status as enum ('received', 'investigating', 'resolved', 'closed', 'rejected');

-- Standards
alter type supasheet.app_permission add value 'quality.standards:select';
...
-- Reports
alter type supasheet.app_permission add value 'quality.inspections_report:select';
alter type supasheet.app_permission add value 'quality.ncr_report:select';
alter type supasheet.app_permission add value 'quality.capa_report:select';
alter type supasheet.app_permission add value 'quality.audit_findings_report:select';
alter type supasheet.app_permission add value 'quality.certifications_register:select';

-- Dashboard widgets
alter type supasheet.app_permission add value 'quality.open_ncrs:select';
alter type supasheet.app_permission add value 'quality.pass_fail_split:select';
alter type supasheet.app_permission add value 'quality.open_capa_value:select';
alter type supasheet.app_permission add value 'quality.quality_health:select';
alter type supasheet.app_permission add value 'quality.recent_inspections:select';
alter type supasheet.app_permission add value 'quality.top_defect_reasons:select';

-- Charts
alter type supasheet.app_permission add value 'quality.inspections_by_result_pie:select';
alter type supasheet.app_permission add value 'quality.ncrs_by_severity_bar:select';
alter type supasheet.app_permission add value 'quality.inspection_trend_line:select';
alter type supasheet.app_permission add value 'quality.audit_findings_radar:select';
...
revoke all on quality.users from authenticated, service_role;
grant select on quality.users to authenticated;
...
revoke all on table quality.standards from authenticated, service_role;
grant select, insert, update, delete on table quality.standards to authenticated;
...
create policy standards_select on quality.standards
    for select to authenticated using (supasheet.has_permission('quality.standards:select'));
create policy standards_insert on quality.standards
    for insert to authenticated with check (supasheet.has_permission('quality.standards:insert'));
create policy standards_update on quality.standards
    for update to authenticated using (supasheet.has_permission('quality.standards:update'))
    with check (supasheet.has_permission('quality.standards:update'));
create policy standards_delete on quality.standards
    for delete to authenticated using (supasheet.has_permission('quality.standards:delete'));
...
revoke all on table quality.inspections from authenticated, service_role;
grant select, insert, update, delete on table quality.inspections to authenticated;
...
create policy inspections_select on quality.inspections
    for select to authenticated using (supasheet.has_permission('quality.inspections:select'));
create policy inspections_insert on quality.inspections
    for insert to authenticated with check (supasheet.has_permission('quality.inspections:insert'));
create policy inspections_update on quality.inspections
    for update to authenticated using (supasheet.has_permission('quality.inspections:update'))
    with check (supasheet.has_permission('quality.inspections:update'));
create policy inspections_delete on quality.inspections
    for delete to authenticated using (supasheet.has_permission('quality.inspections:delete'));
...
revoke all on table quality.inspection_items from authenticated, service_role;
grant select, insert, update, delete on table quality.inspection_items to authenticated;
...
create policy inspection_items_select on quality.inspection_items
    for select to authenticated using (supasheet.has_permission('quality.inspection_items:select'));
create policy inspection_items_insert on quality.inspection_items
    for insert to authenticated with check (supasheet.has_permission('quality.inspection_items:insert'));
create policy inspection_items_update on quality.inspection_items
    for update to authenticated using (supasheet.has_permission('quality.inspection_items:update'))
    with check (supasheet.has_permission('quality.inspection_items:update'));
create policy inspection_items_delete on quality.inspection_items
    for delete to authenticated using (supasheet.has_permission('quality.inspection_items:delete'));
...
revoke all on table quality.non_conformances from authenticated, service_role;
grant select, insert, update, delete on table quality.non_conformances to authenticated;
...
create policy non_conformances_select on quality.non_conformances
    for select to authenticated using (supasheet.has_permission('quality.non_conformances:select'));
create policy non_conformances_insert on quality.non_conformances
    for insert to authenticated with check (supasheet.has_permission('quality.non_conformances:insert'));
create policy non_conformances_update on quality.non_conformances
    for update to authenticated using (supasheet.has_permission('quality.non_conformances:update'))
    with check (supasheet.has_permission('quality.non_conformances:update'));
create policy non_conformances_delete on quality.non_conformances
    for delete to authenticated using (supasheet.has_permission('quality.non_conformances:delete'));
...
revoke all on table quality.capa from authenticated, service_role;
grant select, insert, update, delete on table quality.capa to authenticated;
...
create policy capa_select on quality.capa
    for select to authenticated using (supasheet.has_permission('quality.capa:select'));
create policy capa_insert on quality.capa
    for insert to authenticated with check (supasheet.has_permission('quality.capa:insert'));
create policy capa_update on quality.capa
    for update to authenticated using (supasheet.has_permission('quality.capa:update'))
    with check (supasheet.has_permission('quality.capa:update'));
create policy capa_delete on quality.capa
    for delete to authenticated using (supasheet.has_permission('quality.capa:delete'));
...
revoke all on table quality.audits from authenticated, service_role;
grant select, insert, update, delete on table quality.audits to authenticated;
...
create policy audits_select on quality.audits
    for select to authenticated using (supasheet.has_permission('quality.audits:select'));
create policy audits_insert on quality.audits
    for insert to authenticated with check (supasheet.has_permission('quality.audits:insert'));
create policy audits_update on quality.audits
    for update to authenticated using (supasheet.has_permission('quality.audits:update'))
    with check (supasheet.has_permission('quality.audits:update'));
create policy audits_delete on quality.audits
    for delete to authenticated using (supasheet.has_permission('quality.audits:delete'));
...
revoke all on table quality.audit_findings from authenticated, service_role;
grant select, insert, update, delete on table quality.audit_findings to authenticated;
...
create policy audit_findings_select on quality.audit_findings
    for select to authenticated using (supasheet.has_permission('quality.audit_findings:select'));
create policy audit_findings_insert on quality.audit_findings
    for insert to authenticated with check (supasheet.has_permission('quality.audit_findings:insert'));
create policy audit_findings_update on quality.audit_findings
    for update to authenticated using (supasheet.has_permission('quality.audit_findings:update'))
    with check (supasheet.has_permission('quality.audit_findings:update'));
create policy audit_findings_delete on quality.audit_findings
    for delete to authenticated using (supasheet.has_permission('quality.audit_findings:delete'));
...
revoke all on table quality.certifications from authenticated, service_role;
grant select, insert, update, delete on table quality.certifications to authenticated;
...
create policy certifications_select on quality.certifications
    for select to authenticated using (supasheet.has_permission('quality.certifications:select'));
create policy certifications_insert on quality.certifications
    for insert to authenticated with check (supasheet.has_permission('quality.certifications:insert'));
create policy certifications_update on quality.certifications
    for update to authenticated using (supasheet.has_permission('quality.certifications:update'))
    with check (supasheet.has_permission('quality.certifications:update'));
create policy certifications_delete on quality.certifications
    for delete to authenticated using (supasheet.has_permission('quality.certifications:delete'));
...
revoke all on table quality.complaints from authenticated, service_role;
grant select, insert, update, delete on table quality.complaints to authenticated;
...
create policy complaints_select on quality.complaints
    for select to authenticated using (supasheet.has_permission('quality.complaints:select'));
create policy complaints_insert on quality.complaints
    for insert to authenticated with check (supasheet.has_permission('quality.complaints:insert'));
create policy complaints_update on quality.complaints
    for update to authenticated using (supasheet.has_permission('quality.complaints:update'))
    with check (supasheet.has_permission('quality.complaints:update'));
create policy complaints_delete on quality.complaints
    for delete to authenticated using (supasheet.has_permission('quality.complaints:delete'));
...
select
    ...
    i.fail_count,
    case
        when i.sample_size > 0 then round((i.pass_count::numeric / i.sample_size::numeric) * 100, 1)
        else null
...
revoke all on quality.inspections_report from authenticated, service_role;
grant select on quality.inspections_report to authenticated;
...
select
    ...
    case
        ...
        else extract(day from (current_timestamp - n.discovered_at))::int
    end as days_open,
    a.name as assigned_to,
    i.inspection_number as source_inspection,
    n.created_at
from quality.non_conformances n
left join quality.inspections i on i.id = n.inspection_id
left join supasheet.users a on a.id = n.assigned_user_id;

revoke all on quality.ncr_report from authenticated, service_role;
grant select on quality.ncr_report to authenticated;
...
revoke all on quality.capa_report from authenticated, service_role;
grant select on quality.capa_report to authenticated;
...
revoke all on quality.audit_findings_report from authenticated, service_role;
grant select on quality.audit_findings_report to authenticated;
...
select
    ...
    u.name as contact,
    c.created_at
from quality.certifications c
left join quality.standards s on s.id = c.standard_id
left join supasheet.users u on u.id = c.contact_user_id;

revoke all on quality.certifications_register from authenticated, service_role;
grant select on quality.certifications_register to authenticated;
...
select
    ...
    'open NCRs' as label
from quality.non_conformances
where status in ('open', 'investigating', 'resolved');

revoke all on quality.open_ncrs from authenticated, service_role;
grant select on quality.open_ncrs to authenticated;

-- card_2: pass vs fail (recent inspections)
create or replace view quality.pass_fail_split
with (security_invoker = true) as
select
    count(*) filter (where result = 'passed') as primary,
    count(*) filter (where result = 'failed') as secondary,
...
revoke all on quality.pass_fail_split from authenticated, service_role;
grant select on quality.pass_fail_split to authenticated;

-- card_3: open CAPA cost + closure rate
create or replace view quality.open_capa_value
with (security_invoker = true) as
select
    coalesce(sum(cost) filter (where status in ('open', 'in_progress', 'verification')), 0)::numeric(14, 2) as value,
    case
        when count(*) filter (where status in ('closed', 'cancelled')) > 0
        then round(
            (count(*) filter (where status = 'closed')::numeric
             / count(*) filter (where status in ('closed', 'cancelled'))::numeric) * 100,
            1
        )
        else 0
    end as percent
...
revoke all on quality.open_capa_value from authenticated, service_role;
grant select on quality.open_capa_value to authenticated;
...
with metrics as (
    select
        (select count(*) from quality.capa
            where status in ('open', 'in_progress', 'verification')
              and target_close_date is not null
              and target_close_date < current_date) as overdue_capa,
        (select count(*) from quality.certifications
            where status in ('active', 'expiring_soon')
              and expiry_date is not null
              and expiry_date <= current_date + interval '60 days'
              and expiry_date >= current_date) as expiring_certs,
        (select count(*) from quality.non_conformances
            where status in ('open', 'investigating')
              and severity = 'critical') as critical_open_ncrs,
        (select count(*) from quality.audit_findings
            where status in ('open', 'in_progress', 'resolved')
              and target_close_date is not null
              and target_close_date < current_date) as overdue_findings,
        (select count(*) from quality.non_conformances
            where status in ('open', 'investigating')) as total_open_ncrs
)
select
    (overdue_capa + expiring_certs + critical_open_ncrs + overdue_findings) as current,
    total_open_ncrs as total,
    json_build_array(
        json_build_object('label', 'Overdue CAPA',     'value', overdue_capa),
        json_build_object('label', 'Expiring certs',   'value', expiring_certs),
        json_build_object('label', 'Critical NCRs',    'value', critical_open_ncrs),
        json_build_object('label', 'Overdue findings', 'value', overdue_findings)
    ) as segments
from metrics;

revoke all on quality.quality_health from authenticated, service_role;
grant select on quality.quality_health to authenticated;
...
select
    ...
    to_char(coalesce(completed_at, scheduled_at, created_at), 'MM/DD') as date
from quality.inspections
order by coalesce(completed_at, scheduled_at, created_at) desc
limit 10;

revoke all on quality.recent_inspections from authenticated, service_role;
grant select on quality.recent_inspections to authenticated;
...
group by coalesce(nullif(trim(root_cause), ''), 'Unspecified'), severity
order by count desc
limit 10;

revoke all on quality.top_defect_reasons from authenticated, service_role;
grant select on quality.top_defect_reasons to authenticated;
...
with (security_invoker = true) as
select result::text as label, count(*) as value
from quality.inspections
group by result
order by
    case result
...
revoke all on quality.inspections_by_result_pie from authenticated, service_role;
grant select on quality.inspections_by_result_pie to authenticated;
...
select
    ...
    count(*) filter (where status in ('open', 'investigating', 'resolved'))::bigint as open,
...
revoke all on quality.ncrs_by_severity_bar from authenticated, service_role;
grant select on quality.ncrs_by_severity_bar to authenticated;

-- Line: weekly inspection trend (last 12 weeks)
create or replace view quality.inspection_trend_line
with (security_invoker = true) as
select
    to_char(date_trunc('week', coalesce(completed_at, scheduled_at, created_at)), 'Mon DD') as date,
    count(*) filter (where result = 'passed')::bigint as passed,
    count(*) filter (where result = 'failed')::bigint as failed
from quality.inspections
where coalesce(completed_at, scheduled_at, created_at) >= current_date - interval '12 weeks'
group by date_trunc('week', coalesce(completed_at, scheduled_at, created_at))
order by date_trunc('week', coalesce(completed_at, scheduled_at, created_at));

revoke all on quality.inspection_trend_line from authenticated, service_role;
grant select on quality.inspection_trend_line to authenticated;
...
select
    ...
    count(*) filter (where status in ('resolved', 'verified', 'closed'))::bigint as resolved_count
...
revoke all on quality.audit_findings_radar from authenticated, service_role;
grant select on quality.audit_findings_radar to authenticated;
...
insert into supasheet.role_permissions (role, permission) values
    ...
    ('x-admin', 'quality.certifications_register:select'),
    ...
    ('x-admin', 'quality.inspections_by_result_pie:select'),
...
create trigger audit_qms_standards_insert after insert on quality.standards for each row execute function supasheet.audit_trigger_function();
create trigger audit_qms_standards_update after update on quality.standards for each row execute function supasheet.audit_trigger_function();
create trigger audit_qms_standards_delete before delete on quality.standards for each row execute function supasheet.audit_trigger_function();

create trigger audit_qms_inspections_insert after insert on quality.inspections for each row execute function supasheet.audit_trigger_function();
create trigger audit_qms_inspections_update after update on quality.inspections for each row execute function supasheet.audit_trigger_function();
create trigger audit_qms_inspections_delete before delete on quality.inspections for each row execute function supasheet.audit_trigger_function();

create trigger audit_qms_inspection_items_insert after insert on quality.inspection_items for each row execute function supasheet.audit_trigger_function();
create trigger audit_qms_inspection_items_update after update on quality.inspection_items for each row execute function supasheet.audit_trigger_function();
create trigger audit_qms_inspection_items_delete before delete on quality.inspection_items for each row execute function supasheet.audit_trigger_function();

create trigger audit_qms_ncr_insert after insert on quality.non_conformances for each row execute function supasheet.audit_trigger_function();
create trigger audit_qms_ncr_update after update on quality.non_conformances for each row execute function supasheet.audit_trigger_function();
create trigger audit_qms_ncr_delete before delete on quality.non_conformances for each row execute function supasheet.audit_trigger_function();

create trigger audit_qms_capa_insert after insert on quality.capa for each row execute function supasheet.audit_trigger_function();
create trigger audit_qms_capa_update after update on quality.capa for each row execute function supasheet.audit_trigger_function();
create trigger audit_qms_capa_delete before delete on quality.capa for each row execute function supasheet.audit_trigger_function();

create trigger audit_qms_audits_insert after insert on quality.audits for each row execute function supasheet.audit_trigger_function();
create trigger audit_qms_audits_update after update on quality.audits for each row execute function supasheet.audit_trigger_function();
create trigger audit_qms_audits_delete before delete on quality.audits for each row execute function supasheet.audit_trigger_function();

create trigger audit_qms_audit_findings_insert after insert on quality.audit_findings for each row execute function supasheet.audit_trigger_function();
create trigger audit_qms_audit_findings_update after update on quality.audit_findings for each row execute function supasheet.audit_trigger_function();
create trigger audit_qms_audit_findings_delete before delete on quality.audit_findings for each row execute function supasheet.audit_trigger_function();

create trigger audit_qms_certifications_insert after insert on quality.certifications for each row execute function supasheet.audit_trigger_function();
create trigger audit_qms_certifications_update after update on quality.certifications for each row execute function supasheet.audit_trigger_function();
create trigger audit_qms_certifications_delete before delete on quality.certifications for each row execute function supasheet.audit_trigger_function();

create trigger audit_qms_complaints_insert after insert on quality.complaints for each row execute function supasheet.audit_trigger_function();
create trigger audit_qms_complaints_update after update on quality.complaints for each row execute function supasheet.audit_trigger_function();
create trigger audit_qms_complaints_delete before delete on quality.complaints for each row execute function supasheet.audit_trigger_function();
...
create or replace function quality.trg_ncr_notify()
returns trigger as $$
declare
    v_recipients uuid[];
    v_type   text;
...
create or replace function quality.trg_certifications_notify()
returns trigger as $$
declare
    v_recipients uuid[];
    v_type   text;
