...
values
  ...
  (
    ...
    'active',
    'John Smith',
    'sales@acme-packaging.example.com',
    '+1-415-555-0101',
  ...
  (
    ...
    'active',
    'Michael Brown',
    'wholesale@initech-apparel.example.com',
    '+1-512-555-0118',
  ...
  (
    ...
    'on_hold',
    'James Wilson',
    'orders@wayne-hardware.example.com',
    '+1-201-555-0199',
...
values
  ...
  (
    ...
    0,
    'b0000000-0000-0000-0000-100000000003',
    array['cap', 'discontinued'],
    '#6b7280',
    'Sell through remaining stock.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b4',
    current_timestamp - interval '700 days',
...
values
  ...
  (
    'b0000000-0000-0000-0000-30000000000c',
    'b0000000-0000-0000-0000-000000000002',
    'b0000000-0000-0000-0000-200000000008',
    85,
    10,
  ...
  (
    'b0000000-0000-0000-0000-30000000000d',
    'b0000000-0000-0000-0000-000000000002',
    'b0000000-0000-0000-0000-200000000009',
    35,
    5,
  ...
  (
    'b0000000-0000-0000-0000-30000000000e',
    'b0000000-0000-0000-0000-000000000002',
    'b0000000-0000-0000-0000-20000000000a',
    250,
    0,
  ...
  (
    'b0000000-0000-0000-0000-30000000000f',
    'b0000000-0000-0000-0000-000000000002',
    'b0000000-0000-0000-0000-20000000000b',
    22,
    4,
  ...
  -- SAT-MW
  (
    'b0000000-0000-0000-0000-300000000010',
    'b0000000-0000-0000-0000-000000000003',
    'b0000000-0000-0000-0000-200000000002',
    320,
    40,
  ...
  (
    'b0000000-0000-0000-0000-300000000011',
    'b0000000-0000-0000-0000-000000000003',
    'b0000000-0000-0000-0000-200000000003',
    90,
    8,
  ...
  (
    'b0000000-0000-0000-0000-300000000012',
    'b0000000-0000-0000-0000-000000000003',
    'b0000000-0000-0000-0000-200000000005',
    1200,
    60,
  ...
  (
    'b0000000-0000-0000-0000-300000000013',
    'b0000000-0000-0000-0000-000000000003',
    'b0000000-0000-0000-0000-200000000008',
    60,
    5,
  ...
  -- RET-01
  (
    'b0000000-0000-0000-0000-300000000014',
    'b0000000-0000-0000-0000-000000000004',
    'b0000000-0000-0000-0000-200000000001',
    12,
    0,
    ...
    current_timestamp - interval '12 days',
    'in_stock',
    'Returned units pending refurb.',
    current_timestamp - interval '40 days',
    current_timestamp - interval '12 days'
  ),
  (
    'b0000000-0000-0000-0000-300000000015',
    'b0000000-0000-0000-0000-000000000004',
    'b0000000-0000-0000-0000-20000000000b',
    8,
    0,
...
values
  ...
  (
    ...
    array['electronics', 'replenishment'],
    'Received in full; 1 unit damaged on arrival.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '50 days',
  ...
  (
    ...
    array['apparel'],
    'T-shirts received; hoodies still in transit.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b4',
    current_timestamp - interval '30 days',
    current_timestamp - interval '5 days'
  ),
  ...
  (
    ...
    array['electronics', 'backorder'],
    'Critical — clears the ELC-MSE-004 backorder.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '12 days',
    current_timestamp - interval '6 days'
  ),
  ...
  (
    ...
    array['hardware', 'overdue'],
    'Supplier delayed — escalated.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b4',
    current_timestamp - interval '40 days',
    current_timestamp - interval '5 days'
  ),
...
values
  ...
  (
    'b0000000-0000-0000-0000-500000000001',
    'b0000000-0000-0000-0000-400000000001',
    'b0000000-0000-0000-0000-200000000001',
    200,
    200,
  ...
  (
    'b0000000-0000-0000-0000-500000000002',
    'b0000000-0000-0000-0000-400000000001',
    'b0000000-0000-0000-0000-200000000002',
    1500,
    1499,
    3.20,
    '1 unit damaged on arrival.',
    current_timestamp - interval '50 days'
  ),
  (
    'b0000000-0000-0000-0000-500000000003',
    'b0000000-0000-0000-0000-400000000001',
    'b0000000-0000-0000-0000-200000000003',
    100,
    100,
  ...
  (
    'b0000000-0000-0000-0000-500000000004',
    'b0000000-0000-0000-0000-400000000002',
    'b0000000-0000-0000-0000-200000000008',
    300,
    300,
  ...
  (
    'b0000000-0000-0000-0000-500000000005',
    'b0000000-0000-0000-0000-400000000002',
    'b0000000-0000-0000-0000-200000000009',
    100,
    0,
  ...
  (
    'b0000000-0000-0000-0000-500000000006',
    'b0000000-0000-0000-0000-400000000002',
    'b0000000-0000-0000-0000-20000000000a',
    30,
    30,
    4.50,
    'Final clearance batch.',
    current_timestamp - interval '30 days'
  ),
  -- PO-2026-0003 (confirmed)
  (
    'b0000000-0000-0000-0000-500000000007',
    'b0000000-0000-0000-0000-400000000003',
    'b0000000-0000-0000-0000-200000000004',
    300,
    0,
    11.00,
    'Clears the backorder once received.',
    current_timestamp - interval '12 days'
  ),
  (
    'b0000000-0000-0000-0000-500000000008',
    'b0000000-0000-0000-0000-400000000003',
    'b0000000-0000-0000-0000-200000000003',
    400,
    0,
  ...
  (
    'b0000000-0000-0000-0000-500000000009',
    'b0000000-0000-0000-0000-400000000004',
    'b0000000-0000-0000-0000-200000000005',
    5000,
    0,
  ...
  (
    'b0000000-0000-0000-0000-50000000000a',
    'b0000000-0000-0000-0000-400000000004',
    'b0000000-0000-0000-0000-200000000006',
    1000,
    0,
  ...
  (
    'b0000000-0000-0000-0000-50000000000b',
    'b0000000-0000-0000-0000-400000000004',
    'b0000000-0000-0000-0000-200000000007',
    50,
    0,
  ...
  (
    'b0000000-0000-0000-0000-50000000000c',
    'b0000000-0000-0000-0000-400000000005',
    'b0000000-0000-0000-0000-20000000000b',
    200,
    0,
  ...
  -- PO-2026-0006 (draft)
  (
    'b0000000-0000-0000-0000-50000000000d',
    'b0000000-0000-0000-0000-400000000006',
    'b0000000-0000-0000-0000-20000000000d',
    100,
    0,
  ...
  (
    'b0000000-0000-0000-0000-50000000000e',
    'b0000000-0000-0000-0000-400000000006',
    'b0000000-0000-0000-0000-20000000000e',
    250,
    0,
  ...
  (
    'b0000000-0000-0000-0000-50000000000f',
    'b0000000-0000-0000-0000-400000000007',
    'b0000000-0000-0000-0000-200000000008',
    250,
    0,
  ...
  (
    'b0000000-0000-0000-0000-500000000010',
    'b0000000-0000-0000-0000-400000000007',
    'b0000000-0000-0000-0000-200000000009',
    50,
    0,
...
values
  ...
  (
    ...
    'Initech swag pack.',
    array['swag'],
    'Delayed at carrier hub by 2 days.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b4',
  ...
  (
    ...
    'b0000000-0000-0000-0000-000000000002',
    'Globex Industries',
    'receiving@globex.example.com',
    '88 Industrial Way',
    'Chicago',
    'United States',
    'shipped',
    'usps',
    '9400111899560000000001',
    current_timestamp - interval '1 day',
    (current_date + interval '4 days'),
    null,
    1.2,
  ...
  (
    ...
    array['return'],
    'Items routed to RET-01 for refurb.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b4',
...
values
  ...
  (
    'b0000000-0000-0000-0000-700000000001',
    'b0000000-0000-0000-0000-600000000001',
    'b0000000-0000-0000-0000-200000000001',
    10,
    129.99,
  ...
  (
    'b0000000-0000-0000-0000-700000000002',
    'b0000000-0000-0000-0000-600000000001',
    'b0000000-0000-0000-0000-200000000002',
    25,
    14.99,
  ...
  (
    'b0000000-0000-0000-0000-700000000003',
    'b0000000-0000-0000-0000-600000000001',
    'b0000000-0000-0000-0000-200000000003',
    10,
    39.99,
  ...
  (
    'b0000000-0000-0000-0000-700000000004',
    'b0000000-0000-0000-0000-600000000002',
    'b0000000-0000-0000-0000-200000000008',
    20,
    24.99,
  ...
  (
    'b0000000-0000-0000-0000-700000000005',
    'b0000000-0000-0000-0000-600000000002',
    'b0000000-0000-0000-0000-200000000009',
    10,
    64.99,
  ...
  (
    'b0000000-0000-0000-0000-700000000006',
    'b0000000-0000-0000-0000-600000000003',
    'b0000000-0000-0000-0000-20000000000d',
    5,
    229.99,
  ...
  (
    'b0000000-0000-0000-0000-700000000007',
    'b0000000-0000-0000-0000-600000000003',
    'b0000000-0000-0000-0000-20000000000e',
    12,
    39.99,
  ...
  (
    'b0000000-0000-0000-0000-700000000008',
    'b0000000-0000-0000-0000-600000000004',
    'b0000000-0000-0000-0000-200000000001',
    2,
    129.99,
  ...
  (
    'b0000000-0000-0000-0000-700000000009',
    'b0000000-0000-0000-0000-600000000004',
    'b0000000-0000-0000-0000-200000000002',
    5,
    14.99,
  ...
  (
    'b0000000-0000-0000-0000-70000000000a',
    'b0000000-0000-0000-0000-600000000005',
    'b0000000-0000-0000-0000-200000000008',
    30,
    24.99,
  ...
  (
    'b0000000-0000-0000-0000-70000000000b',
    'b0000000-0000-0000-0000-600000000005',
    'b0000000-0000-0000-0000-200000000009',
    15,
    64.99,
  ...
  (
    'b0000000-0000-0000-0000-70000000000c',
    'b0000000-0000-0000-0000-600000000005',
    'b0000000-0000-0000-0000-20000000000e',
    15,
    39.99,
  ...
  (
    'b0000000-0000-0000-0000-70000000000d',
    'b0000000-0000-0000-0000-600000000006',
    'b0000000-0000-0000-0000-200000000001',
    1,
    129.99,
...
values
  ...
  (
    'b0000000-0000-0000-0000-800000000001',
    'MOV-2026-0001',
    'purchase_in',
    'b0000000-0000-0000-0000-200000000001',
    'b0000000-0000-0000-0000-000000000001',
  ...
  (
    'b0000000-0000-0000-0000-800000000002',
    'MOV-2026-0002',
    'purchase_in',
    'b0000000-0000-0000-0000-200000000002',
    'b0000000-0000-0000-0000-000000000001',
    ...
    current_timestamp - interval '34 days',
    'PO receipt',
    '1 unit damaged not received.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '34 days'
  ),
  -- Damage out (the broken cable)
  (
    'b0000000-0000-0000-0000-800000000003',
    'MOV-2026-0003',
    'damage_out',
    'b0000000-0000-0000-0000-200000000002',
    'b0000000-0000-0000-0000-000000000001',
    ...
    current_timestamp - interval '34 days',
    'Damaged on arrival',
    'Discarded; supplier credit pending.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '34 days'
  ),
  -- Sale outs (matching delivered shipment SHP-2026-0001)
  (
    'b0000000-0000-0000-0000-800000000004',
    'MOV-2026-0004',
    'sale_out',
    'b0000000-0000-0000-0000-200000000001',
    'b0000000-0000-0000-0000-000000000001',
  ...
  (
    'b0000000-0000-0000-0000-800000000005',
    'MOV-2026-0005',
    'sale_out',
    'b0000000-0000-0000-0000-200000000002',
    'b0000000-0000-0000-0000-000000000001',
  ...
  (
    'b0000000-0000-0000-0000-800000000006',
    'MOV-2026-0006',
    'transfer_out',
    'b0000000-0000-0000-0000-200000000005',
    'b0000000-0000-0000-0000-000000000001',
  ...
  (
    'b0000000-0000-0000-0000-800000000007',
    'MOV-2026-0007',
    'transfer_in',
    'b0000000-0000-0000-0000-200000000005',
    'b0000000-0000-0000-0000-000000000003',
  ...
  (
    'b0000000-0000-0000-0000-800000000008',
    'MOV-2026-0008',
    'sale_out',
    'b0000000-0000-0000-0000-200000000008',
    'b0000000-0000-0000-0000-000000000002',
  ...
  (
    'b0000000-0000-0000-0000-800000000009',
    'MOV-2026-0009',
    'sale_out',
    'b0000000-0000-0000-0000-200000000009',
    'b0000000-0000-0000-0000-000000000002',
  ...
  (
    'b0000000-0000-0000-0000-80000000000a',
    'MOV-2026-0010',
    'adjustment',
    'b0000000-0000-0000-0000-200000000005',
    'b0000000-0000-0000-0000-000000000001',
    ...
    'Counted vs system; adjusted down.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '5 days'
  ),
  -- Return inbound (RET-01)
  (
    'b0000000-0000-0000-0000-80000000000b',
    'MOV-2026-0011',
    'return_in',
    'b0000000-0000-0000-0000-200000000001',
    'b0000000-0000-0000-0000-000000000004',
  ...
  (
    'b0000000-0000-0000-0000-80000000000c',
    'MOV-2026-0012',
    'purchase_in',
    'b0000000-0000-0000-0000-200000000008',
    'b0000000-0000-0000-0000-000000000002',
