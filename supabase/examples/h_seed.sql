...
set
  manager_id = 'e0000000-0000-0000-0000-200000000001'
where
  id = 'e0000000-0000-0000-0000-000000000005';

update hr.departments
set
  manager_id = 'e0000000-0000-0000-0000-200000000002'
where
...
update hr.departments
set
  manager_id = 'e0000000-0000-0000-0000-200000000005'
where
  id = 'e0000000-0000-0000-0000-000000000007';

update hr.departments
set
  manager_id = 'e0000000-0000-0000-0000-200000000006'
where
  id = 'e0000000-0000-0000-0000-000000000002';

update hr.departments
set
  manager_id = 'e0000000-0000-0000-0000-200000000007'
where
  id = 'e0000000-0000-0000-0000-000000000003';

update hr.departments
set
  manager_id = 'e0000000-0000-0000-0000-200000000009'
where
...
values
  ...
  (
    ...
    current_date - interval '116 days',
    5,
    'Family bereavement.',
    'Approved.',
    'e0000000-0000-0000-0000-200000000001',
...
values
  ...
  (
    ...
    205000.00,
    'USD',
    'https://www.linkedin.com/in/henry-adams',
    4.5,
  ...
  (
    ...
    190000.00,
    'USD',
    'https://www.linkedin.com/in/grace-kim',
    4.0,
    array['inbound'],
  ...
  (
    ...
    180000.00,
    'USD',
    'https://www.linkedin.com/in/owen-diaz',
    2.0,
    array['rejected'],
  ...
  (
    ...
    160000.00,
    'USD',
    'https://www.linkedin.com/in/chloe-foster',
    4.8,
    array['offer-out'],
  ...
  (
    ...
    130000.00,
    'USD',
    'https://www.linkedin.com/in/ryan-murphy',
    null,
    array['inbound'],
  ...
  (
    ...
    165000.00,
    'USD',
    'https://www.linkedin.com/in/ella-ortiz',
    4.2,
  ...
  (
    ...
    150000.00,
    'USD',
    'https://www.linkedin.com/in/nathan-walker',
    null,
    array['withdrawn'],
  ...
  (
    ...
    72000.00,
    'USD',
    'https://www.linkedin.com/in/aiden-brooks',
    4.5,
    array['hired', 'intern'],
    'Started 60 days ago.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
