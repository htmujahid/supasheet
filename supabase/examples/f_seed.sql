...
values
  ...
  (
    ...
    'Initech Office Supplies LLC',
    'V-002',
    'https://initech-office.example.com',
    'billing@initech-office.example.com',
    '+1-512-555-0118',
    '4120 Tech Boulevard',
    'Austin',
    'United States',
  ...
  (
    ...
    'Globex Cloud',
    'Globex Cloud Holdings',
    'V-003',
    'https://cloud.globex.example.com',
  ...
  (
    ...
    'Wayne Legal',
    'Wayne & Associates LLP',
    'V-004',
    'https://wayne-legal.example.com',
    'ar@wayne-legal.example.com',
    '+1-201-555-0199',
    '1007 Mountain Drive',
    'Gotham',
    'United States',
...
values
  ...
  (
    ...
    'INV-2026-0002',
    'Initech Software',
    'finance@initech.example.com',
    '4120 Tech Boulevard, Austin, TX',
    'paid',
  ...
  (
    ...
    'INV-2026-0003',
    'Stark Industries',
    'ap@stark.example.com',
    '10880 Malibu Point, New York, NY',
    'paid',
  ...
  (
    ...
    'INV-2026-0004',
    'Globex Industries',
    'billing@globex.example.com',
    '88 Industrial Way, Chicago, IL',
    'sent',
    current_date - interval '15 days',
    current_date + interval '15 days',
    null,
  ...
  (
    ...
    'finance@umbrella.example.com',
    '200 Research Park, Raccoon City, IL',
    'sent',
  ...
  (
    ...
    'INV-2026-0006',
    'Wayne Enterprises',
    'ap@wayne.example.com',
    '1007 Mountain Drive, Gotham, NJ',
    'sent',
  ...
  (
    ...
    'INV-2026-0008',
    'Soylent Foods',
    'ap@soylent.example.com',
    '77 Beacon Street, Boston, MA',
    'overdue',
    current_date - interval '90 days',
    current_date - interval '60 days',
    null,
  ...
  (
    ...
    'INV-2026-0009',
    'Cyberdyne Systems',
    'ap@cyberdyne.example.com',
    '18144 El Camino Real, Sunnyvale, CA',
    'draft',
...
values
  ...
  (
    ...
    'Customer dinner with Stark execs.',
    'Le Bernardin',
    'credit_card',
    'f0000000-0000-0000-0000-00000000000b',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b4',
  ...
  (
    ...
    'Booth materials for trade show.',
    'PrintCo',
    'credit_card',
    'f0000000-0000-0000-0000-00000000000c',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b4',
    current_timestamp - interval '15 days',
    'Rejected — exceeds approved trade show budget.',
    null,
    array['marketing', 'rejected'],
    'Resubmit under FY budget once approved.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b4',
  ...
  (
    ...
    'EXP-2026-0009',
    'Lucas Patel',
    'lucas.patel@example.com',
    'travel',
    'submitted',
    642.30,
    'USD',
    current_date - interval '3 days',
    'Train tickets — customer visit.',
    'Amtrak',
    'credit_card',
    'f0000000-0000-0000-0000-00000000000b',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b4',
  ...
  (
    ...
    null,
    array['draft'],
    'Will submit once receipt arrives.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '1 day',
    current_timestamp - interval '1 day'
  );
...
values
  ...
  (
    ...
    (
      date_trunc('month', current_date) - interval '1 month + 4 days'
    )::date,
    'completed',
    148000.00,
    22500.00,
  ...
  (
    ...
    array['monthly', 'processing'],
    'Reviewing time-off adjustments.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '5 days',
    current_timestamp - interval '1 day'
  );
