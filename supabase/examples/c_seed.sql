...
values
  ...
  (
    ...
    'https://www.linkedin.com/in/john-smith-acme',
    null,
    array['champion', 'eng'],
    'Always happy to take a call.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
  ...
  (
    ...
    'Sarah',
    'Johnson',
    'sarah.johnson@globex.example.com',
    '+1-312-555-0142',
    '+1-312-555-2142',
    ...
    'https://www.linkedin.com/in/sarah-johnson-globex',
    null,
    array['evaluator', 'ops'],
    'Decision-maker on procurement track.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
  ...
  (
    ...
    'Michael',
    'Brown',
    'michael.brown@initech.example.com',
    '+1-512-555-0119',
    '+1-512-555-2119',
    'CTO',
    'Technology',
    ...
    'https://www.linkedin.com/in/michael-brown-initech',
    'https://x.com/mbrown_initech',
    array['cto', 'expansion'],
    'Wants quarterly roadmap reviews.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
  ...
  (
    ...
    'Emily',
    'Davis',
    'emily.davis@globex.example.com',
    '+1-312-555-0143',
    null,
    'Procurement Manager',
    'Procurement',
    ...
    'https://www.linkedin.com/in/emily-davis-globex',
    null,
    array['procurement', 'event-lead'],
    'Send an updated quote next week.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
  ...
  (
    ...
    'James',
    'Wilson',
    'james.wilson@wayne.example.com',
    '+1-201-555-0144',
    '+1-201-555-2144',
    ...
    'https://www.linkedin.com/in/james-wilson-wayne',
    null,
    array['partner', 'exec'],
    'Joint marketing planning ongoing.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
  ...
  (
    ...
    'https://www.linkedin.com/in/lisa-anderson',
    'https://x.com/lisa_anderson',
    array['startup', 'founder'],
    'Self-serve trial in progress.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
  ...
  (
    ...
    'David',
    'Martinez',
    'david.martinez@acme.example.com',
    '+1-415-555-0146',
    null,
    'Engineering Manager',
    'Engineering',
    ...
    'https://www.linkedin.com/in/david-martinez-acme',
    null,
    array['eng', 'daily-driver'],
    'Files most support tickets.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
  ...
  (
    ...
    'https://www.linkedin.com/in/jennifer-taylor',
    null,
    array['inbound', 'marketing'],
    'Send the SMB pricing one-pager.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '12 days',
    current_timestamp - interval '12 days'
  ),
  (
    ...
    'Robert',
    'Thomas',
    'robert.thomas@initech.example.com',
    '+1-512-555-0148',
    null,
    'VP Customer Success',
    'Customer Success',
    ...
    'https://www.linkedin.com/in/robert-thomas-initech',
    null,
    array['cs', 'customer'],
  ...
  (
    ...
    'Patricia',
    'Hernandez',
    'patricia.hernandez@example.com',
    null,
    null,
    'Independent Advisor',
    'External',
    ...
    'https://www.linkedin.com/in/patricia-hernandez',
    null,
    array['advisor', 'alumni'],
    'Re-engage when she lands somewhere new.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
  ...
  (
    ...
    'https://www.linkedin.com/in/chris-moore',
    null,
    array['security', 'inbound'],
    'Wants to see SOC 2 documentation.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b4',
    current_timestamp - interval '20 days',
    current_timestamp - interval '20 days'
  ),
  (
    ...
    'Jessica',
    'Jackson',
    'jessica.jackson@umbrella.example.com',
    '+1-415-555-0151',
    '+1-415-555-2151',
    'VP Research',
    'R&D',
    ...
    'https://www.linkedin.com/in/jessica-jackson-umbrella',
    null,
    array['research', 'pov-driver'],
    'POV is in week 3.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b4',
  ...
  (
    ...
    'Daniel',
    'White',
    'daniel.white@stark.example.com',
    '+1-212-555-0152',
    null,
    ...
    'https://www.linkedin.com/in/daniel-white-stark',
    null,
    array['platform', 'tech'],
    'Backups for John Smith on call rotation.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b4',
  ...
  (
    ...
    'https://www.linkedin.com/in/ashley-harris',
    null,
    array['outbound', 'ops'],
    'Opening discovery next week.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b4',
  ...
  (
    ...
    'https://www.linkedin.com/in/matt-lewis-stark',
    null,
    array['procurement', 'renewal'],
    'Wants 3-year discount terms next cycle.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b4',
  ...
  (
    ...
    'Amanda',
    'Walker',
    'amanda.walker@umbrella.example.com',
    '+1-415-555-0155',
    null,
    ...
    'https://www.linkedin.com/in/amanda-walker-umbrella',
    null,
    array['procurement', 'pharma'],
    'Asked for redlines on MSA.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b4',
  ...
  (
    ...
    'https://www.linkedin.com/in/josh-hall',
    null,
    array['arch', 'event-lead'],
    'Wants a technical deep-dive.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b4',
  ...
  (
    ...
    'Megan',
    'Allen',
    'megan.allen@soylent.example.com',
    '+1-617-555-0158',
    null,
    'Director of Channel',
    'Sales',
    ...
    'https://www.linkedin.com/in/megan-allen-soylent',
    null,
    array['channel', 'partner'],
    'JBP cadence is monthly.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b4',
    current_timestamp - interval '180 days',
  ...
  (
    ...
    'Andrew',
    'Young',
    'andrew.young@cyberdyne.example.com',
    '+1-408-555-0159',
    null,
    'Account Executive',
    'Sales',
    ...
    'https://www.linkedin.com/in/andrew-young-cyberdyne',
    null,
    array['vendor', 'sales'],
  ...
  (
    ...
    'https://www.linkedin.com/in/rebecca-king',
    null,
    array['alumni'],
    'Maintain warm relationship for future moves.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b4',
    current_timestamp - interval '500 days',
    current_timestamp - interval '120 days'
  );
...
values
  ...
  (
    ...
    'c0000000-0000-0000-0000-000000000005',
    'c0000000-0000-0000-0000-100000000015',
    array['renewal', 'multi-year', 'enterprise'],
    '#ef4444',
  ...
  (
    ...
    'c0000000-0000-0000-0000-000000000008',
    'c0000000-0000-0000-0000-100000000018',
    array['partner', 'expansion', 'retail'],
    '#22c55e',
  ...
  (
    ...
    'c0000000-0000-0000-0000-000000000005',
    'c0000000-0000-0000-0000-100000000013',
    array['security', 'expansion', 'closed-won'],
    '#dc2626',
...
values
  ...
  (
    'Renewal kickoff call',
    'Walk through renewal options with John and David.',
    'call',
    'completed',
    ...
    'c0000000-0000-0000-0000-000000000001',
    array['renewal'],
    'Acme team aligned on expansion scope.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '38 days',
    current_timestamp - interval '38 days'
  ),
  (
    'Send renewal quote',
    'Email renewal quote with discount tiers.',
    'email',
    'completed',
    current_timestamp - interval '30 days',
    current_timestamp - interval '30 days',
  ...
  (
    'Procurement redline review',
    'Sync with Acme procurement on contract redlines.',
    'meeting',
    'pending',
    current_timestamp + interval '3 days',
    null,
  ...
  (
    ...
    'Initial discovery on operations pain points.',
    'call',
    'completed',
    current_timestamp - interval '28 days',
    current_timestamp - interval '28 days',
  ...
  (
    'Send proposal',
    'Initial proposal with Standard tier and add-on options.',
    'email',
    'completed',
    current_timestamp - interval '20 days',
    current_timestamp - interval '20 days',
  ...
  (
    'Procurement Q&A with Emily',
    'Procurement-side questions on terms.',
    'call',
    'pending',
    current_timestamp + interval '5 days',
    null,
  ...
  (
    'Roadmap review with Michael',
    'Walk through analytics roadmap.',
    'meeting',
    'completed',
    current_timestamp - interval '15 days',
    current_timestamp - interval '15 days',
  ...
  (
    ...
    'Document expansion pricing approach.',
    'note',
    'completed',
    current_timestamp - interval '10 days',
    current_timestamp - interval '10 days',
  ...
  (
    'Pilot retro with James',
    'Retrospective on pilot rollout.',
    'meeting',
    'completed',
    current_timestamp - interval '10 days',
    current_timestamp - interval '10 days',
  ...
  (
    ...
    'Plan joint webinar series for next quarter.',
    'meeting',
    'in_progress',
    current_timestamp + interval '7 days',
    null,
  ...
  (
    'Scope SOW',
    'Draft scope of work for services package.',
    'task',
    'in_progress',
    current_timestamp + interval '2 days',
    null,
  ...
  (
    'Discovery with Lisa Anderson',
    'Self-serve trial follow-up.',
    'call',
    'pending',
    current_timestamp + interval '4 days',
    null,
  ...
  (
    ...
    'Email SMB pricing PDF to Jennifer.',
    'email',
    'pending',
    current_timestamp + interval '1 day',
    null,
  ...
  (
    'Quarterly health review with Robert',
    'Review adoption metrics and account health.',
    'meeting',
    'completed',
    current_timestamp - interval '12 days',
    current_timestamp - interval '12 days',
    ...
    'c0000000-0000-0000-0000-000000000003',
    array['cs', 'qbr'],
    'Health is green; expansion conversation primed.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '12 days',
    current_timestamp - interval '12 days'
  ),
  ...
  (
    'Stark exec briefing',
    'Briefing for Stark executive sponsors on renewal.',
    'meeting',
    'completed',
    current_timestamp - interval '12 days',
    current_timestamp - interval '12 days',
  ...
  (
    'Send 3-year proposal',
    'Email Matt the 3-year discount proposal.',
    'email',
    'completed',
    current_timestamp - interval '6 days',
    current_timestamp - interval '6 days',
  ...
  (
    'Stark final pricing call',
    'Final pricing review with Matt and exec.',
    'call',
    'pending',
    current_timestamp + interval '5 days',
    null,
  ...
  -- Soylent expansion
  (
    'Channel JBP working session',
    'Joint business plan working session.',
    'meeting',
    'completed',
    current_timestamp - interval '20 days',
    current_timestamp - interval '20 days',
  ...
  (
    'Retail SKU scoping',
    'Scope which retail SKUs to include.',
    'note',
    'completed',
    current_timestamp - interval '10 days',
    current_timestamp - interval '10 days',
  ...
  (
    'Security suite kickoff',
    'Kickoff after closing the security add-on.',
    'meeting',
    'completed',
    current_timestamp - interval '5 days',
    current_timestamp - interval '5 days',
  ...
  (
    'Send SOC 2 report',
    'Email Christopher our SOC 2 Type II report.',
    'email',
    'completed',
    current_timestamp - interval '6 days',
    current_timestamp - interval '6 days',
  ...
  (
    ...
    'Deep-dive on security architecture for Christopher.',
    'meeting',
    'pending',
    current_timestamp + interval '6 days',
    null,
  ...
  (
    'Outbound discovery',
    'First discovery call from outbound sequence.',
    'call',
    'pending',
    current_timestamp + interval '6 days',
    null,
  ...
  (
    'Technical deep-dive with Josh',
    'Architecture deep-dive after AWS re:Invent.',
    'meeting',
    'pending',
    current_timestamp + interval '10 days',
    null,
  ...
  (
    'Cyberdyne renewal sign-off',
    'Final sign-off note for the Cyberdyne vendor renewal.',
    'note',
    'completed',
    current_timestamp - interval '40 days',
    current_timestamp - interval '40 days',
  ...
  (
    'Loss debrief',
    'Loss debrief and nurture plan for Soylent pilot.',
    'note',
    'completed',
    current_timestamp - interval '28 days',
    current_timestamp - interval '28 days',
  ...
  (
    ...
    'Define success metrics for Umbrella pilot.',
    'task',
    'in_progress',
    current_timestamp + interval '4 days',
    null,
  ...
  (
    'Cyberdyne quarterly check-in',
    'Vendor quarterly call with Andrew.',
    'call',
    'pending',
    current_timestamp + interval '20 days',
    null,
