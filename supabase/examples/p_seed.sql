...
values
  (
    ...
    'SUP-A001',
    'Globex Components',
    'Globex Components Inc.',
    'preferred',
    'strategic',
    'Sarah Johnson',
    'orders@globex-components.example.com',
    '+1-312-555-0100',
  ...
  (
    ...
    'SUP-A002',
    'Wayne Industrial',
    'Wayne Industrial LLC',
    'qualified',
    'tier_1',
    'James Wilson',
    'sales@wayne-industrial.example.com',
    '+1-201-555-0199',
  ...
  (
    ...
    'SUP-A003',
    'Stark International',
    'Stark International Holdings',
    'preferred',
    'strategic',
    'Daniel White',
    'logistics@stark-intl.example.com',
    '+1-212-555-0152',
  ...
  (
    ...
    'SUP-A004',
    'Initech Services',
    'Initech Services LLC',
    'on_hold',
    'tier_2',
    'Michael Brown',
    'sales@initech-services.example.com',
    '+1-512-555-0118',
  ...
  (
    ...
    'SUP-A005',
    'Soylent Catering',
    'Soylent Catering Group',
    'pending',
    'transactional',
    'Megan Allen',
    'invoices@soylent.example.com',
    '+1-617-555-0156',
  ...
  (
    ...
    'SUP-A006',
    'Cyberdyne Reseller',
    'Cyberdyne Reseller LLC',
    'blacklisted',
    'tier_3',
    null,
    'sales@cyberdyne-reseller.example.com',
    null,
    null,
    null,
    'Sunnyvale',
    ...
    'Do not engage.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '950 days',
...
values
  ...
  (
    ...
    'CTR-2026-0001',
    'Globex Components — Master Supply Agreement',
    'a0000000-0000-0000-0000-000000000001',
    'master',
    'active',
  ...
  (
    ...
    'CTR-2026-0002',
    'Wayne Industrial — Hardware Supply',
    'a0000000-0000-0000-0000-000000000002',
    'msa',
    'expiring_soon',
    current_date - interval '700 days',
  ...
  (
    ...
    'CTR-2026-0003',
    'Stark International — Premium Logistics SOW',
    'a0000000-0000-0000-0000-000000000003',
    'sow',
    'active',
  ...
  (
    ...
    'CTR-2026-0005',
    'Initech Services — Consulting Retainer',
    'a0000000-0000-0000-0000-000000000004',
    'msa',
    'expired',
  ...
  (
    ...
    'CTR-2026-0006',
    'Cyberdyne Reseller — Component Resale (terminated)',
    'a0000000-0000-0000-0000-000000000006',
    'spot',
    'terminated',
    current_date - interval '900 days',
...
values
  ...
  (
    ...
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '12 days',
    'Approved — proceed with sourcing.',
    null,
    array['office', 'furniture'],
    '#0ea5e9',
    null,
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
  ...
  (
    ...
    'Rejected — out of FY budget. Resubmit next quarter.',
    null,
    array['office', 'rejected'],
    '#94a3b8',
    null,
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '20 days',
...
values
  -- REQ-0001 (laptops)
  (
    'a0000000-0000-0000-0000-300000000001',
    'a0000000-0000-0000-0000-200000000001',
    10,
    'Engineering laptop — 16" Pro',
    'IT-LPT-PRO16',
    'High-spec dev laptop.',
    'IT/Hardware',
    15,
    'each',
    3000.00,
  ...
  -- REQ-0002 (furniture)
  (
    'a0000000-0000-0000-0000-300000000002',
    'a0000000-0000-0000-0000-200000000002',
    10,
    'Lounge sofa',
    'OFC-SOFA-LG',
  ...
  (
    'a0000000-0000-0000-0000-300000000003',
    'a0000000-0000-0000-0000-200000000002',
    20,
    'Lounge chair',
    'OFC-CHR-LG',
  ...
  (
    'a0000000-0000-0000-0000-300000000004',
    'a0000000-0000-0000-0000-200000000002',
    30,
    'Coffee table',
    'OFC-TBL-CF',
  ...
  (
    'a0000000-0000-0000-0000-300000000005',
    'a0000000-0000-0000-0000-200000000003',
    10,
    'Booth backdrop banner',
    'MKT-BNR-BD',
    '8x10ft printed backdrop.',
    'Marketing/Print',
    1,
    'each',
    1500.00,
  ...
  (
    'a0000000-0000-0000-0000-300000000006',
    'a0000000-0000-0000-0000-200000000003',
    20,
    'Branded notebooks',
    'MKT-NTB-BR',
    'Hardcover branded notebooks.',
    'Marketing/Swag',
    500,
    'each',
    12.00,
  ...
  (
    'a0000000-0000-0000-0000-300000000007',
    'a0000000-0000-0000-0000-200000000003',
    30,
    'Pens (branded)',
    'MKT-PEN-BR',
  ...
  (
    'a0000000-0000-0000-0000-300000000008',
    'a0000000-0000-0000-0000-200000000004',
    10,
    'Travel pouch (branded)',
    'SLS-TRV-POU',
    null,
    'Sales/Swag',
    30,
  ...
  (
    'a0000000-0000-0000-0000-300000000009',
    'a0000000-0000-0000-0000-200000000004',
    20,
    'Power bank 10K',
    'SLS-PWR-10K',
  ...
  -- REQ-0006 (UPS units)
  (
    'a0000000-0000-0000-0000-30000000000a',
    'a0000000-0000-0000-0000-200000000006',
    10,
    'Rack UPS 3kVA',
    'IT-UPS-3K',
  ...
  (
    'a0000000-0000-0000-0000-30000000000b',
    'a0000000-0000-0000-0000-200000000006',
    20,
...
values
  ...
  (
    ...
    'RFQ-2026-0004',
    'Espresso machine RFQ (cancelled)',
    'cancelled',
    'a0000000-0000-0000-0000-200000000005',
...
values
  -- RFQ-0001 quotes
  (
    'a0000000-0000-0000-0000-500000000001',
    'Q-2026-0001-A',
    'a0000000-0000-0000-0000-400000000001',
    'a0000000-0000-0000-0000-000000000001',
    'awarded',
    ...
    'Globex laptop quote — best price + warranty.',
    'Awarded.',
    4.7,
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '32 days',
  ...
  (
    'a0000000-0000-0000-0000-500000000002',
    'Q-2026-0001-B',
    'a0000000-0000-0000-0000-400000000001',
    'a0000000-0000-0000-0000-000000000002',
    'rejected',
    ...
    'Wayne quote — higher price, faster delivery.',
    'Rejected on price.',
    4.0,
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '30 days',
  ...
  (
    'a0000000-0000-0000-0000-500000000003',
    'Q-2026-0001-C',
    'a0000000-0000-0000-0000-400000000001',
    'a0000000-0000-0000-0000-000000000004',
    'rejected',
  ...
  (
    'a0000000-0000-0000-0000-500000000004',
    'Q-2026-0002-A',
    'a0000000-0000-0000-0000-400000000002',
    'a0000000-0000-0000-0000-000000000003',
    'shortlisted',
    ...
    'Net 30',
    null,
    'Stark furniture proposal.',
    'Premium look — preferred.',
    4.6,
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '5 days',
    current_timestamp - interval '2 days'
  ...
  (
    'a0000000-0000-0000-0000-500000000005',
    'Q-2026-0002-B',
    'a0000000-0000-0000-0000-400000000002',
    'a0000000-0000-0000-0000-000000000002',
    'submitted',
    ...
    'Net 45',
    null,
    'Wayne furniture proposal.',
    'Cheapest — under review.',
    4.0,
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '3 days',
    current_timestamp - interval '3 days'
  ...
  (
    'a0000000-0000-0000-0000-500000000006',
    'Q-2026-0003-A',
    'a0000000-0000-0000-0000-400000000003',
    'a0000000-0000-0000-0000-000000000002',
    'shortlisted',
  ...
  (
    'a0000000-0000-0000-0000-500000000007',
    'Q-2026-0003-B',
    'a0000000-0000-0000-0000-400000000003',
    'a0000000-0000-0000-0000-000000000001',
    'submitted',
  ...
  (
    'a0000000-0000-0000-0000-500000000008',
    'Q-2026-0004-A',
    'a0000000-0000-0000-0000-400000000004',
    'a0000000-0000-0000-0000-000000000005',
    'withdrawn',
    ...
    'Net 15',
    null,
    'Espresso machine quote.',
    'Withdrawn after RFQ cancelled.',
    null,
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b4',
    current_timestamp - interval '15 days',
    current_timestamp - interval '8 days'
...
values
  (
    'a0000000-0000-0000-0000-600000000001',
    'CAT-IT',
    'IT Hardware',
    null,
    'Laptops, monitors, networking gear.',
    'straight_line',
    36,
    5.00,
    '#3b82f6',
  ...
  (
    'a0000000-0000-0000-0000-600000000002',
    'CAT-IT-LP',
    'Laptops',
    'a0000000-0000-0000-0000-600000000001',
    'Engineering and corporate laptops.',
    'straight_line',
    36,
    5.00,
    '#0ea5e9',
  ...
  (
    'a0000000-0000-0000-0000-600000000003',
    'CAT-OFC',
    'Office Furniture',
    null,
    'Desks, chairs, lounge furniture.',
    'straight_line',
    84,
    10.00,
    '#22c55e',
  ...
  (
    'a0000000-0000-0000-0000-600000000004',
    'CAT-VEH',
    'Vehicles',
    null,
    'Company cars, vans.',
  ...
  (
    'a0000000-0000-0000-0000-600000000005',
    'CAT-MFG',
...
values
  ...
  (
    ...
    1582.00,
    1268.00,
    current_date + interval '460 days',
    true,
    'POL-IT-001',
    current_date - interval '180 days',
    current_date + interval '180 days',
    array['laptop', 'engineering'],
    '#3b82f6',
    null,
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
  ...
  (
    ...
    230.00,
    2620.00,
    current_date + interval '985 days',
    true,
    'POL-IT-001',
    null,
    current_date + interval '275 days',
  ...
  (
    ...
    11400.00,
    26600.00,
    current_date + interval '230 days',
    true,
    'POL-FLT-001',
    current_date - interval '60 days',
    current_date + interval '120 days',
  ...
  (
    ...
    0,
    2850.00,
    current_date + interval '1068 days',
    true,
    'POL-IT-001',
    null,
  ...
  (
    ...
    'SF HQ — IT Storage',
    'IT',
    current_date - interval '1500 days',
    2400.00,
    'USD',
    'straight_line',
    36,
    ...
    'Awaiting disposal.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '1500 days',
    current_timestamp - interval '90 days'
  );
...
values
  -- Active
  (
    'a0000000-0000-0000-0000-800000000001',
    'a0000000-0000-0000-0000-700000000001',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    'Olivia Bennett',
    'People Operations',
  ...
  (
    'a0000000-0000-0000-0000-800000000002',
    'a0000000-0000-0000-0000-700000000002',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b4',
    'Sophia Martinez',
    'Sales',
  ...
  (
    'a0000000-0000-0000-0000-800000000003',
    'a0000000-0000-0000-0000-700000000005',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b4',
    'Logistics Pool',
    'Logistics',
  ...
  (
    'a0000000-0000-0000-0000-800000000004',
    'a0000000-0000-0000-0000-700000000006',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    'Liam Carter',
    'Engineering',
  ...
  (
    'a0000000-0000-0000-0000-800000000005',
    'a0000000-0000-0000-0000-700000000003',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    'Ava Singh',
    'Engineering',
    ...
    current_timestamp - interval '7 days',
    'SF HQ — IT Bench',
    'Daily work laptop — returned for repair.',
    'fair',
    'Battery swelled.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '900 days',
  ...
  (
    'a0000000-0000-0000-0000-800000000006',
    'a0000000-0000-0000-0000-700000000004',
    null,
    'Operations Pool',
    'Operations',
    ...
    current_timestamp - interval '5 days',
    'SF HQ — North Lobby',
    'Lobby refresh — repositioned.',
    'excellent',
    'Moved between lobbies.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '60 days',
    current_timestamp - interval '5 days'
  ),
  -- Lost
  (
    'a0000000-0000-0000-0000-800000000007',
    'a0000000-0000-0000-0000-700000000008',
    null,
    'Unassigned',
    'IT',
    ...
    'Old loaner pool.',
    'poor',
    'Reported lost during office move.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '1500 days',
    current_timestamp - interval '90 days'
  );
...
values
  ...
  (
    'a0000000-0000-0000-0000-900000000001',
    'MNT-2026-0001',
    'a0000000-0000-0000-0000-700000000006',
    'preventive',
    'completed',
    ...
    850.00,
    'USD',
    'Coolant filter, way oil 5L.',
    'All within spec.',
    current_date + interval '60 days',
    array['preventive', 'cnc'],
    null,
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
  ...
  (
    'a0000000-0000-0000-0000-900000000002',
    'MNT-2026-0002',
    'a0000000-0000-0000-0000-700000000003',
    'corrective',
    'in_progress',
  ...
  (
    'a0000000-0000-0000-0000-900000000003',
    'MNT-2026-0003',
    'a0000000-0000-0000-0000-700000000005',
    'preventive',
    'scheduled',
  ...
  -- Scheduled overdue
  (
    'a0000000-0000-0000-0000-900000000004',
    'MNT-2026-0004',
    'a0000000-0000-0000-0000-700000000001',
    'inspection',
    'scheduled',
    ...
    null,
    current_date + interval '358 days',
    array['inspection', 'laptop', 'overdue'],
  ...
  (
    'a0000000-0000-0000-0000-900000000005',
    'MNT-2026-0005',
    'a0000000-0000-0000-0000-700000000006',
    'calibration',
    'completed',
  ...
  -- Cancelled
  (
    'a0000000-0000-0000-0000-900000000006',
    'MNT-2026-0006',
    'a0000000-0000-0000-0000-700000000008',
    'corrective',
    'cancelled',
  ...
  -- Upgrade
  (
    'a0000000-0000-0000-0000-900000000007',
    'MNT-2026-0007',
    'a0000000-0000-0000-0000-700000000002',
    'upgrade',
    'completed',
