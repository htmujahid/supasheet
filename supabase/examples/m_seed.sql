...
values
  ...
  (
    'd0000000-0000-0000-0000-200000000001',
    'd0000000-0000-0000-0000-100000000001',
    10,
    'CMP-DRV-40',
    'Driver Unit 40mm',
  ...
  (
    'd0000000-0000-0000-0000-200000000002',
    'd0000000-0000-0000-0000-100000000001',
    20,
    'CMP-PCB-WHP',
    'Headphone Mainboard',
  ...
  (
    'd0000000-0000-0000-0000-200000000003',
    'd0000000-0000-0000-0000-100000000001',
    30,
    'CMP-BAT-LIPO',
    '900mAh LiPo Battery',
  ...
  (
    'd0000000-0000-0000-0000-200000000004',
    'd0000000-0000-0000-0000-100000000001',
    40,
    'CMP-HSG-WHP',
    'Headphone Housing Pair',
    null,
    1,
    'set',
    1.0,
  ...
  (
    'd0000000-0000-0000-0000-200000000005',
    'd0000000-0000-0000-0000-100000000001',
    50,
    'CMP-PAD-EAR',
    'Memory Foam Earpads',
  ...
  (
    'd0000000-0000-0000-0000-200000000006',
    'd0000000-0000-0000-0000-100000000001',
    60,
    'PKG-BOX-WHP',
    'Retail Box',
  ...
  (
    'd0000000-0000-0000-0000-200000000007',
    'd0000000-0000-0000-0000-100000000002',
    10,
    'CMP-WIR-USBC',
    'USB-C Wire 2m',
  ...
  (
    'd0000000-0000-0000-0000-200000000008',
    'd0000000-0000-0000-0000-100000000002',
    20,
    'CMP-CON-USBC',
    'USB-C Connector',
  ...
  (
    'd0000000-0000-0000-0000-200000000009',
    'd0000000-0000-0000-0000-100000000002',
    30,
    'CMP-BRD-NYL',
    'Nylon Braid Sleeve',
  ...
  (
    'd0000000-0000-0000-0000-20000000000a',
    'd0000000-0000-0000-0000-100000000003',
    10,
    'CMP-PCB-DOC',
    'Dock Mainboard',
  ...
  (
    'd0000000-0000-0000-0000-20000000000b',
    'd0000000-0000-0000-0000-100000000003',
    20,
    'CMP-HSG-DOC',
    'Aluminum Dock Housing',
    null,
    1,
    'each',
    1.0,
  ...
  (
    'd0000000-0000-0000-0000-20000000000c',
    'd0000000-0000-0000-0000-100000000003',
    30,
    'CMP-CBL-PIG',
    'Pigtail Cable USB-C',
  ...
  (
    'd0000000-0000-0000-0000-20000000000d',
    'd0000000-0000-0000-0000-100000000003',
    40,
    'PKG-BOX-DOC',
    'Dock Retail Box',
  ...
  (
    'd0000000-0000-0000-0000-20000000000e',
    'd0000000-0000-0000-0000-100000000004',
    10,
    'CMP-LTH-FG',
    'Full-grain Leather Panel Set',
    null,
    1,
    'set',
    1.0,
  ...
  (
    'd0000000-0000-0000-0000-20000000000f',
    'd0000000-0000-0000-0000-100000000004',
    20,
    'CMP-ZIP-YKK',
    'YKK Zipper 60cm',
  ...
  (
    'd0000000-0000-0000-0000-200000000010',
    'd0000000-0000-0000-0000-100000000004',
    30,
    'CMP-STR-WBG',
    'Webbing Strap',
  ...
  (
    'd0000000-0000-0000-0000-200000000011',
    'd0000000-0000-0000-0000-100000000004',
    40,
    'CMP-HW-BUK',
    'Brass Buckle Set',
  ...
  (
    'd0000000-0000-0000-0000-200000000012',
    'd0000000-0000-0000-0000-100000000004',
    50,
    'PKG-BAG-DST',
    'Dust Bag',
...
values
  ...
  (
    ...
    'd0000000-0000-0000-0000-100000000002',
    'active',
    'Cut → Solder → Sleeve → Pack (batch of 50).',
    90,
    array['electronics', 'batch'],
    null,
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
  ...
  (
    ...
    'd0000000-0000-0000-0000-100000000003',
    'draft',
    'Pilot routing for first build.',
    35,
    array['hardware', 'pilot'],
    'Awaiting time-study finalization.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b4',
    current_timestamp - interval '15 days',
    current_timestamp - interval '3 days'
  ),
  (
    ...
    'd0000000-0000-0000-0000-100000000004',
    'active',
    'Cut → Stitch → Finish → Inspect → Pack.',
    75,
    array['accessories'],
    null,
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b4',
...
values
  ...
  (
    'd0000000-0000-0000-0000-400000000001',
    'd0000000-0000-0000-0000-300000000001',
    10,
    'Assemble PCB & drivers',
    'Solder drivers to PCB, install in housing.',
    'd0000000-0000-0000-0000-000000000001',
    5,
    8.0,
    'Follow ASM-WHP-001 work instruction.',
    null,
    current_timestamp - interval '180 days'
  ),
  (
    'd0000000-0000-0000-0000-400000000002',
    'd0000000-0000-0000-0000-300000000001',
    20,
    'In-line inspection',
    ...
    2,
    4.0,
    'Acoustic test using rig A.',
    null,
    current_timestamp - interval '180 days'
  ),
  (
    'd0000000-0000-0000-0000-400000000003',
    'd0000000-0000-0000-0000-300000000001',
    30,
    'Pack & label',
  ...
  (
    'd0000000-0000-0000-0000-400000000004',
    'd0000000-0000-0000-0000-300000000002',
    10,
    'Cut & strip wires',
  ...
  (
    'd0000000-0000-0000-0000-400000000005',
    'd0000000-0000-0000-0000-300000000002',
    20,
    'Solder connectors',
  ...
  (
    'd0000000-0000-0000-0000-400000000006',
    'd0000000-0000-0000-0000-300000000002',
    30,
    'Apply nylon sleeve',
    null,
  ...
  (
    'd0000000-0000-0000-0000-400000000007',
    'd0000000-0000-0000-0000-300000000002',
    40,
    'Bag & label',
    null,
  ...
  (
    'd0000000-0000-0000-0000-400000000008',
    'd0000000-0000-0000-0000-300000000003',
    10,
    'Assemble dock',
  ...
  (
    'd0000000-0000-0000-0000-400000000009',
    'd0000000-0000-0000-0000-300000000003',
    20,
    'Functional test',
  ...
  (
    'd0000000-0000-0000-0000-40000000000a',
    'd0000000-0000-0000-0000-300000000003',
    30,
    'Pack',
    null,
  ...
  (
    'd0000000-0000-0000-0000-40000000000b',
    'd0000000-0000-0000-0000-300000000004',
    10,
    'Cut leather panels',
    null,
  ...
  (
    'd0000000-0000-0000-0000-40000000000c',
    'd0000000-0000-0000-0000-300000000004',
    20,
    'Stitch & assemble',
    null,
  ...
  (
    'd0000000-0000-0000-0000-40000000000d',
    'd0000000-0000-0000-0000-300000000004',
    30,
    'Finish edges',
    null,
  ...
  (
    'd0000000-0000-0000-0000-40000000000e',
    'd0000000-0000-0000-0000-300000000004',
    40,
    'Inspect',
    null,
  ...
  (
    'd0000000-0000-0000-0000-40000000000f',
    'd0000000-0000-0000-0000-300000000004',
    50,
    'Pack & ship',
    null,
...
values
  ...
  (
    ...
    null,
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    array['electronics', 'batch', 'future'],
    '#0284c7',
    null,
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '3 days',
...
values
  -- WO-0001 (completed)
  (
    'd0000000-0000-0000-0000-600000000001',
    'd0000000-0000-0000-0000-500000000001',
    'd0000000-0000-0000-0000-400000000001',
    'd0000000-0000-0000-0000-000000000001',
    10,
  ...
  (
    'd0000000-0000-0000-0000-600000000002',
    'd0000000-0000-0000-0000-500000000001',
    'd0000000-0000-0000-0000-400000000002',
    'd0000000-0000-0000-0000-000000000004',
    20,
  ...
  (
    'd0000000-0000-0000-0000-600000000003',
    'd0000000-0000-0000-0000-500000000001',
    'd0000000-0000-0000-0000-400000000003',
    'd0000000-0000-0000-0000-000000000003',
    30,
  ...
  -- WO-0002 (completed)
  (
    'd0000000-0000-0000-0000-600000000004',
    'd0000000-0000-0000-0000-500000000002',
    'd0000000-0000-0000-0000-400000000004',
    'd0000000-0000-0000-0000-000000000002',
    10,
  ...
  (
    'd0000000-0000-0000-0000-600000000005',
    'd0000000-0000-0000-0000-500000000002',
    'd0000000-0000-0000-0000-400000000005',
    'd0000000-0000-0000-0000-000000000001',
    20,
    ...
    20,
    null,
    'Solder defects on first 20.',
    current_timestamp - interval '40 days',
    current_timestamp - interval '23 days'
  ),
  (
    'd0000000-0000-0000-0000-600000000006',
    'd0000000-0000-0000-0000-500000000002',
    'd0000000-0000-0000-0000-400000000007',
    'd0000000-0000-0000-0000-000000000003',
    40,
  ...
  (
    'd0000000-0000-0000-0000-600000000007',
    'd0000000-0000-0000-0000-500000000003',
    'd0000000-0000-0000-0000-40000000000b',
    'd0000000-0000-0000-0000-000000000002',
    10,
  ...
  (
    'd0000000-0000-0000-0000-600000000008',
    'd0000000-0000-0000-0000-500000000003',
    'd0000000-0000-0000-0000-40000000000c',
    'd0000000-0000-0000-0000-000000000001',
    20,
    ...
    1,
    null,
    '1 unit set aside for rework.',
    current_timestamp - interval '15 days',
    current_timestamp - interval '6 hours'
  ),
  (
    'd0000000-0000-0000-0000-600000000009',
    'd0000000-0000-0000-0000-500000000003',
    'd0000000-0000-0000-0000-40000000000d',
    'd0000000-0000-0000-0000-000000000005',
    30,
    ...
    0,
    null,
    'Blocked: WC-FIN-01 in maintenance.',
    current_timestamp - interval '15 days',
    current_timestamp - interval '15 days'
  ),
  (
    'd0000000-0000-0000-0000-60000000000a',
    'd0000000-0000-0000-0000-500000000003',
    'd0000000-0000-0000-0000-40000000000e',
    'd0000000-0000-0000-0000-000000000004',
    40,
  ...
  (
    'd0000000-0000-0000-0000-60000000000b',
    'd0000000-0000-0000-0000-500000000003',
    'd0000000-0000-0000-0000-40000000000f',
    'd0000000-0000-0000-0000-000000000003',
    50,
  ...
  (
    'd0000000-0000-0000-0000-60000000000c',
    'd0000000-0000-0000-0000-500000000004',
    'd0000000-0000-0000-0000-400000000001',
    'd0000000-0000-0000-0000-000000000001',
    10,
  ...
  (
    'd0000000-0000-0000-0000-60000000000d',
    'd0000000-0000-0000-0000-500000000004',
    'd0000000-0000-0000-0000-400000000002',
    'd0000000-0000-0000-0000-000000000004',
    20,
  ...
  (
    'd0000000-0000-0000-0000-60000000000e',
    'd0000000-0000-0000-0000-500000000004',
    'd0000000-0000-0000-0000-400000000003',
    'd0000000-0000-0000-0000-000000000003',
    30,
...
values
  ...
  (
    'd0000000-0000-0000-0000-700000000001',
    'MI-2026-0001',
    'd0000000-0000-0000-0000-500000000001',
    'd0000000-0000-0000-0000-200000000001',
    'CMP-DRV-40',
    ...
    'issued',
    current_timestamp - interval '40 days',
    '2 extra for scrap allowance.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '41 days',
    current_timestamp - interval '40 days'
  ),
  (
    'd0000000-0000-0000-0000-700000000002',
    'MI-2026-0002',
    'd0000000-0000-0000-0000-500000000001',
    'd0000000-0000-0000-0000-200000000002',
    'CMP-PCB-WHP',
  ...
  (
    'd0000000-0000-0000-0000-700000000003',
    'MI-2026-0003',
    'd0000000-0000-0000-0000-500000000001',
    'd0000000-0000-0000-0000-200000000003',
    'CMP-BAT-LIPO',
  ...
  (
    'd0000000-0000-0000-0000-700000000004',
    'MI-2026-0004',
    'd0000000-0000-0000-0000-500000000001',
    'd0000000-0000-0000-0000-200000000005',
    'CMP-PAD-EAR',
  ...
  (
    'd0000000-0000-0000-0000-700000000005',
    'MI-2026-0005',
    'd0000000-0000-0000-0000-500000000002',
    'd0000000-0000-0000-0000-200000000007',
    'CMP-WIR-USBC',
  ...
  (
    'd0000000-0000-0000-0000-700000000006',
    'MI-2026-0006',
    'd0000000-0000-0000-0000-500000000002',
    'd0000000-0000-0000-0000-200000000008',
    'CMP-CON-USBC',
    ...
    'issued',
    current_timestamp - interval '28 days',
    '30 returned after solder defect mid-run.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '31 days',
    current_timestamp - interval '23 days'
  ),
  ...
  (
    'd0000000-0000-0000-0000-700000000007',
    'MI-2026-0007',
    'd0000000-0000-0000-0000-500000000003',
    'd0000000-0000-0000-0000-20000000000e',
    'CMP-LTH-FG',
  ...
  (
    'd0000000-0000-0000-0000-700000000008',
    'MI-2026-0008',
    'd0000000-0000-0000-0000-500000000003',
    'd0000000-0000-0000-0000-20000000000f',
    'CMP-ZIP-YKK',
  ...
  (
    'd0000000-0000-0000-0000-700000000009',
    'MI-2026-0009',
    'd0000000-0000-0000-0000-500000000004',
    'd0000000-0000-0000-0000-200000000001',
    'CMP-DRV-40',
    ...
    'reserved',
    null,
    'Reserved for upcoming run.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    current_timestamp - interval '4 days',
    current_timestamp - interval '4 days'
  ),
  (
    'd0000000-0000-0000-0000-70000000000a',
    'MI-2026-0010',
    'd0000000-0000-0000-0000-500000000004',
    'd0000000-0000-0000-0000-200000000002',
    'CMP-PCB-WHP',
...
values
  -- WO-0001 outputs
  (
    'd0000000-0000-0000-0000-800000000001',
    'OUT-2026-0001',
    'd0000000-0000-0000-0000-500000000001',
    'd0000000-0000-0000-0000-000000000003',
    'good',
  ...
  (
    'd0000000-0000-0000-0000-800000000002',
    'OUT-2026-0002',
    'd0000000-0000-0000-0000-500000000001',
    'd0000000-0000-0000-0000-000000000004',
    'scrap',
  ...
  -- WO-0002 outputs
  (
    'd0000000-0000-0000-0000-800000000003',
    'OUT-2026-0003',
    'd0000000-0000-0000-0000-500000000002',
    'd0000000-0000-0000-0000-000000000003',
    'good',
  ...
  (
    'd0000000-0000-0000-0000-800000000004',
    'OUT-2026-0004',
    'd0000000-0000-0000-0000-500000000002',
    'd0000000-0000-0000-0000-000000000001',
    'scrap',
    ...
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    0.5,
    'Cold solder joints on first 20.',
    null,
    array['cable', 'scrap'],
    null,
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
  ...
  (
    'd0000000-0000-0000-0000-800000000005',
    'OUT-2026-0005',
    'd0000000-0000-0000-0000-500000000003',
    'd0000000-0000-0000-0000-000000000004',
    'good',
  ...
  (
    'd0000000-0000-0000-0000-800000000006',
    'OUT-2026-0006',
    'd0000000-0000-0000-0000-500000000003',
    'd0000000-0000-0000-0000-000000000004',
    'rework',
    ...
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b4',
    2.5,
    'Stitching loose on side seam.',
    null,
    array['bag', 'rework'],
    'Sending back for re-stitch.',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b4',
    current_timestamp - interval '8 hours',
    current_timestamp - interval '6 hours'
  ),
  ...
  (
    'd0000000-0000-0000-0000-800000000007',
    'OUT-2026-0007',
    'd0000000-0000-0000-0000-500000000003',
    'd0000000-0000-0000-0000-000000000001',
    'pending_inspection',
