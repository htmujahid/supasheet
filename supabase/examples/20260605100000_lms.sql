...
create type lms.lesson_type as enum ('video', 'article', 'quiz', 'assignment', 'live_session', 'reading', 'download');
create type lms.lesson_status as enum ('draft', 'published', 'hidden');
create type lms.enrollment_status as enum ('active', 'completed', 'paused', 'dropped', 'expired');
create type lms.progress_status as enum ('not_started', 'in_progress', 'completed', 'skipped');
create type lms.assignment_type as enum ('quiz', 'essay', 'project', 'peer_review', 'practical');
create type lms.submission_status as enum ('draft', 'submitted', 'graded', 'returned', 'late');
...
-- Courses
alter type supasheet.app_permission add value 'lms.courses:select';
...
-- Reports
alter type supasheet.app_permission add value 'lms.courses_report:select';
alter type supasheet.app_permission add value 'lms.enrollments_report:select';
alter type supasheet.app_permission add value 'lms.learner_progress_report:select';
alter type supasheet.app_permission add value 'lms.assignment_grades_report:select';
alter type supasheet.app_permission add value 'lms.certificates_register:select';

-- Dashboard widgets
alter type supasheet.app_permission add value 'lms.active_enrollments:select';
alter type supasheet.app_permission add value 'lms.completion_split:select';
alter type supasheet.app_permission add value 'lms.completion_rate_summary:select';
alter type supasheet.app_permission add value 'lms.lms_health:select';
alter type supasheet.app_permission add value 'lms.recent_enrollments:select';
alter type supasheet.app_permission add value 'lms.top_courses:select';

-- Charts
alter type supasheet.app_permission add value 'lms.courses_by_category_pie:select';
alter type supasheet.app_permission add value 'lms.enrollments_by_course_bar:select';
alter type supasheet.app_permission add value 'lms.enrollment_trend_line:select';
alter type supasheet.app_permission add value 'lms.lesson_type_metrics_radar:select';
...
revoke all on lms.users from authenticated, service_role;
grant select on lms.users to authenticated;
...
revoke all on table lms.courses from authenticated, service_role;
grant select, insert, update, delete on table lms.courses to authenticated;
...
create policy courses_select on lms.courses
    for select to authenticated using (supasheet.has_permission('lms.courses:select'));
create policy courses_insert on lms.courses
    for insert to authenticated with check (supasheet.has_permission('lms.courses:insert'));
create policy courses_update on lms.courses
    for update to authenticated using (supasheet.has_permission('lms.courses:update'))
    with check (supasheet.has_permission('lms.courses:update'));
create policy courses_delete on lms.courses
    for delete to authenticated using (supasheet.has_permission('lms.courses:delete'));
...
revoke all on table lms.modules from authenticated, service_role;
grant select, insert, update, delete on table lms.modules to authenticated;
...
create policy modules_select on lms.modules
    for select to authenticated using (supasheet.has_permission('lms.modules:select'));
create policy modules_insert on lms.modules
    for insert to authenticated with check (supasheet.has_permission('lms.modules:insert'));
create policy modules_update on lms.modules
    for update to authenticated using (supasheet.has_permission('lms.modules:update'))
    with check (supasheet.has_permission('lms.modules:update'));
create policy modules_delete on lms.modules
    for delete to authenticated using (supasheet.has_permission('lms.modules:delete'));
...
revoke all on table lms.lessons from authenticated, service_role;
grant select, insert, update, delete on table lms.lessons to authenticated;
...
create policy lessons_select on lms.lessons
    for select to authenticated using (supasheet.has_permission('lms.lessons:select'));
create policy lessons_insert on lms.lessons
    for insert to authenticated with check (supasheet.has_permission('lms.lessons:insert'));
create policy lessons_update on lms.lessons
    for update to authenticated using (supasheet.has_permission('lms.lessons:update'))
    with check (supasheet.has_permission('lms.lessons:update'));
create policy lessons_delete on lms.lessons
    for delete to authenticated using (supasheet.has_permission('lms.lessons:delete'));
...
revoke all on table lms.enrollments from authenticated, service_role;
grant select, insert, update, delete on table lms.enrollments to authenticated;
...
create policy enrollments_select on lms.enrollments
    for select to authenticated using (supasheet.has_permission('lms.enrollments:select'));
create policy enrollments_insert on lms.enrollments
    for insert to authenticated with check (supasheet.has_permission('lms.enrollments:insert'));
create policy enrollments_update on lms.enrollments
    for update to authenticated using (supasheet.has_permission('lms.enrollments:update'))
    with check (supasheet.has_permission('lms.enrollments:update'));
create policy enrollments_delete on lms.enrollments
    for delete to authenticated using (supasheet.has_permission('lms.enrollments:delete'));
...
revoke all on table lms.lesson_progress from authenticated, service_role;
grant select, insert, update, delete on table lms.lesson_progress to authenticated;
...
create policy lesson_progress_select on lms.lesson_progress
    for select to authenticated using (supasheet.has_permission('lms.lesson_progress:select'));
create policy lesson_progress_insert on lms.lesson_progress
    for insert to authenticated with check (supasheet.has_permission('lms.lesson_progress:insert'));
create policy lesson_progress_update on lms.lesson_progress
    for update to authenticated using (supasheet.has_permission('lms.lesson_progress:update'))
    with check (supasheet.has_permission('lms.lesson_progress:update'));
create policy lesson_progress_delete on lms.lesson_progress
    for delete to authenticated using (supasheet.has_permission('lms.lesson_progress:delete'));
...
revoke all on table lms.assignments from authenticated, service_role;
grant select, insert, update, delete on table lms.assignments to authenticated;
...
create policy assignments_select on lms.assignments
    for select to authenticated using (supasheet.has_permission('lms.assignments:select'));
create policy assignments_insert on lms.assignments
    for insert to authenticated with check (supasheet.has_permission('lms.assignments:insert'));
create policy assignments_update on lms.assignments
    for update to authenticated using (supasheet.has_permission('lms.assignments:update'))
    with check (supasheet.has_permission('lms.assignments:update'));
create policy assignments_delete on lms.assignments
    for delete to authenticated using (supasheet.has_permission('lms.assignments:delete'));
...
revoke all on table lms.submissions from authenticated, service_role;
grant select, insert, update, delete on table lms.submissions to authenticated;
...
create policy submissions_select on lms.submissions
    for select to authenticated using (supasheet.has_permission('lms.submissions:select'));
create policy submissions_insert on lms.submissions
    for insert to authenticated with check (supasheet.has_permission('lms.submissions:insert'));
create policy submissions_update on lms.submissions
    for update to authenticated using (supasheet.has_permission('lms.submissions:update'))
    with check (supasheet.has_permission('lms.submissions:update'));
create policy submissions_delete on lms.submissions
    for delete to authenticated using (supasheet.has_permission('lms.submissions:delete'));
...
revoke all on table lms.certificates from authenticated, service_role;
grant select, insert, update, delete on table lms.certificates to authenticated;
...
create policy certificates_select on lms.certificates
    for select to authenticated using (supasheet.has_permission('lms.certificates:select'));
create policy certificates_insert on lms.certificates
    for insert to authenticated with check (supasheet.has_permission('lms.certificates:insert'));
create policy certificates_update on lms.certificates
    for update to authenticated using (supasheet.has_permission('lms.certificates:update'))
    with check (supasheet.has_permission('lms.certificates:update'));
create policy certificates_delete on lms.certificates
    for delete to authenticated using (supasheet.has_permission('lms.certificates:delete'));
...
revoke all on table lms.learning_paths from authenticated, service_role;
grant select, insert, update, delete on table lms.learning_paths to authenticated;
...
create policy learning_paths_select on lms.learning_paths
    for select to authenticated using (supasheet.has_permission('lms.learning_paths:select'));
create policy learning_paths_insert on lms.learning_paths
    for insert to authenticated with check (supasheet.has_permission('lms.learning_paths:insert'));
create policy learning_paths_update on lms.learning_paths
    for update to authenticated using (supasheet.has_permission('lms.learning_paths:update'))
    with check (supasheet.has_permission('lms.learning_paths:update'));
create policy learning_paths_delete on lms.learning_paths
    for delete to authenticated using (supasheet.has_permission('lms.learning_paths:delete'));
...
select
    ...
    case
        when count(distinct e.id) > 0
            then round((count(distinct e.id) filter (where e.status = 'completed')::numeric
                       / count(distinct e.id)::numeric) * 100, 1)
        else 0
...
revoke all on lms.courses_report from authenticated, service_role;
grant select on lms.courses_report to authenticated;
...
select
    ...
    case
        ...
        else extract(day from (current_timestamp - e.last_accessed_at))::int
...
revoke all on lms.enrollments_report from authenticated, service_role;
grant select on lms.enrollments_report to authenticated;
...
select
    ...
    avg(lp.score) filter (where lp.score is not null) as avg_lesson_score,
    e.progress_pct,
...
revoke all on lms.learner_progress_report from authenticated, service_role;
grant select on lms.learner_progress_report to authenticated;
...
select
    ...
    s.score,
    s.max_score,
    case when s.max_score > 0 then round((s.score / s.max_score) * 100, 1) else null end as score_pct,
    s.is_passing,
    s.submitted_at,
    s.graded_at,
    g.name as grader,
    case
        ...
        else extract(day from (current_timestamp - s.submitted_at))::int
...
revoke all on lms.assignment_grades_report from authenticated, service_role;
grant select on lms.assignment_grades_report to authenticated;
...
select
    ...
    cert.issued_at,
    cert.expires_at,
    case when cert.expires_at is null then null else (cert.expires_at::date - current_date)::int end as days_to_expiry,
    cert.final_score,
    cert.grade,
    i.name as issuer,
...
revoke all on lms.certificates_register from authenticated, service_role;
grant select on lms.certificates_register to authenticated;
...
revoke all on lms.active_enrollments from authenticated, service_role;
grant select on lms.active_enrollments to authenticated;
...
select
    ...
    count(*) filter (where status = 'active') as secondary,
    'Completed' as primary_label,
    'In progress' as secondary_label
from lms.enrollments;

revoke all on lms.completion_split from authenticated, service_role;
grant select on lms.completion_split to authenticated;
...
select
    ...
    case
        when count(*) filter (where status in ('completed', 'dropped', 'expired')) > 0
        then round(
            (count(*) filter (where status = 'completed')::numeric
             / count(*) filter (where status in ('completed', 'dropped', 'expired'))::numeric) * 100,
            1
        )
        else 0
    end as percent
...
revoke all on lms.completion_rate_summary from authenticated, service_role;
grant select on lms.completion_rate_summary to authenticated;
...
with metrics as (
    select
        (select count(*) from lms.assignments
            where is_published = true
              and due_at is not null
              and due_at < current_timestamp) as overdue_assignments,
        (select count(*) from lms.enrollments
            where status = 'active'
              and (last_accessed_at is null or last_accessed_at < current_timestamp - interval '30 days')) as stale_enrollments,
        (select count(*) from lms.certificates
            where status = 'issued'
              and expires_at is not null
              and expires_at <= current_timestamp + interval '60 days'
              and expires_at >= current_timestamp) as expiring_certs,
        (select count(*) from lms.submissions
            where status = 'late') as late_submissions,
        (select count(*) from lms.enrollments where status = 'active') as active_total
)
select
    (overdue_assignments + stale_enrollments + expiring_certs + late_submissions) as current,
    active_total as total,
    json_build_array(
        json_build_object('label', 'Overdue assignments', 'value', overdue_assignments),
        json_build_object('label', 'Stale enrollments',   'value', stale_enrollments),
        json_build_object('label', 'Expiring certs',      'value', expiring_certs),
        json_build_object('label', 'Late submissions',    'value', late_submissions)
    ) as segments
from metrics;

revoke all on lms.lms_health from authenticated, service_role;
grant select on lms.lms_health to authenticated;
...
revoke all on lms.recent_enrollments from authenticated, service_role;
grant select on lms.recent_enrollments to authenticated;
...
select
    ...
    count(e.id) filter (where e.status = 'completed')::bigint as completions
from lms.courses c
left join lms.enrollments e on e.course_id = c.id
...
revoke all on lms.top_courses from authenticated, service_role;
grant select on lms.top_courses to authenticated;
...
revoke all on lms.courses_by_category_pie from authenticated, service_role;
grant select on lms.courses_by_category_pie to authenticated;
...
select
    c.title as label,
    count(e.id) filter (where e.status = 'active')::bigint as active,
...
revoke all on lms.enrollments_by_course_bar from authenticated, service_role;
grant select on lms.enrollments_by_course_bar to authenticated;
...
select
    ...
    count(*) filter (where completed_at is not null and completed_at <= current_timestamp)::bigint as completed
from lms.enrollments
where enrolled_at >= current_date - interval '12 weeks'
group by date_trunc('week', enrolled_at)
order by date_trunc('week', enrolled_at);

revoke all on lms.enrollment_trend_line from authenticated, service_role;
grant select on lms.enrollment_trend_line to authenticated;
...
select
    ...
    count(lp.id) filter (where lp.status = 'completed')::bigint as completed_progress,
    count(lp.id) filter (where lp.status = 'in_progress')::bigint as active_progress
from lms.lessons l
left join lms.lesson_progress lp on lp.lesson_id = l.id
group by l.type;

revoke all on lms.lesson_type_metrics_radar from authenticated, service_role;
grant select on lms.lesson_type_metrics_radar to authenticated;
...
create trigger audit_lms_courses_insert after insert on lms.courses for each row execute function supasheet.audit_trigger_function();
create trigger audit_lms_courses_update after update on lms.courses for each row execute function supasheet.audit_trigger_function();
create trigger audit_lms_courses_delete before delete on lms.courses for each row execute function supasheet.audit_trigger_function();

create trigger audit_lms_modules_insert after insert on lms.modules for each row execute function supasheet.audit_trigger_function();
create trigger audit_lms_modules_update after update on lms.modules for each row execute function supasheet.audit_trigger_function();
create trigger audit_lms_modules_delete before delete on lms.modules for each row execute function supasheet.audit_trigger_function();

create trigger audit_lms_lessons_insert after insert on lms.lessons for each row execute function supasheet.audit_trigger_function();
create trigger audit_lms_lessons_update after update on lms.lessons for each row execute function supasheet.audit_trigger_function();
create trigger audit_lms_lessons_delete before delete on lms.lessons for each row execute function supasheet.audit_trigger_function();

create trigger audit_lms_enrollments_insert after insert on lms.enrollments for each row execute function supasheet.audit_trigger_function();
create trigger audit_lms_enrollments_update after update on lms.enrollments for each row execute function supasheet.audit_trigger_function();
create trigger audit_lms_enrollments_delete before delete on lms.enrollments for each row execute function supasheet.audit_trigger_function();

create trigger audit_lms_lesson_progress_insert after insert on lms.lesson_progress for each row execute function supasheet.audit_trigger_function();
create trigger audit_lms_lesson_progress_update after update on lms.lesson_progress for each row execute function supasheet.audit_trigger_function();
create trigger audit_lms_lesson_progress_delete before delete on lms.lesson_progress for each row execute function supasheet.audit_trigger_function();

create trigger audit_lms_assignments_insert after insert on lms.assignments for each row execute function supasheet.audit_trigger_function();
create trigger audit_lms_assignments_update after update on lms.assignments for each row execute function supasheet.audit_trigger_function();
create trigger audit_lms_assignments_delete before delete on lms.assignments for each row execute function supasheet.audit_trigger_function();

create trigger audit_lms_submissions_insert after insert on lms.submissions for each row execute function supasheet.audit_trigger_function();
create trigger audit_lms_submissions_update after update on lms.submissions for each row execute function supasheet.audit_trigger_function();
create trigger audit_lms_submissions_delete before delete on lms.submissions for each row execute function supasheet.audit_trigger_function();

create trigger audit_lms_certificates_insert after insert on lms.certificates for each row execute function supasheet.audit_trigger_function();
create trigger audit_lms_certificates_update after update on lms.certificates for each row execute function supasheet.audit_trigger_function();
create trigger audit_lms_certificates_delete before delete on lms.certificates for each row execute function supasheet.audit_trigger_function();

create trigger audit_lms_paths_insert after insert on lms.learning_paths for each row execute function supasheet.audit_trigger_function();
create trigger audit_lms_paths_update after update on lms.learning_paths for each row execute function supasheet.audit_trigger_function();
create trigger audit_lms_paths_delete before delete on lms.learning_paths for each row execute function supasheet.audit_trigger_function();
...
create or replace function lms.trg_enrollments_notify()
returns trigger as $$
declare
    v_recipients uuid[];
    v_course_title text;
...
create or replace function lms.trg_submissions_notify()
returns trigger as $$
declare
    v_recipients uuid[];
...
create or replace function lms.trg_certificates_notify()
returns trigger as $$
declare
    v_recipients uuid[];
    v_type   text;
