...
INSERT INTO store.orders (id, order_number, user_id, status, payment_method, subtotal, tax, shipping, total, shipping_address, tracking_number, notes, created_at, updated_at) VALUES
-- User 1 orders
(
    'd1e2f3a4-b5c6-7890-defa-bc1234580001', 'ORD-2024-0001',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b8',
    'delivered', 'credit_card', 159.98, 0, 0, 159.98,
    '123 Main St, Springfield, IL 62701', 'TRK1Z999AA10000001',
    NULL,
    current_timestamp - interval '60 days', current_timestamp - interval '55 days'
),
(
    'd1e2f3a4-b5c6-7890-defa-bc1234580002', 'ORD-2024-0002',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b8',
    'delivered', 'paypal', 49.99, 0, 0, 49.99,
    '123 Main St, Springfield, IL 62701', 'TRK1Z999AA10000002',
    'Leave at door',
    current_timestamp - interval '45 days', current_timestamp - interval '40 days'
),
(
    'd1e2f3a4-b5c6-7890-defa-bc1234580003', 'ORD-2024-0003',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b8',
    'shipped', 'credit_card', 84.98, 0, 0, 84.98,
    '123 Main St, Springfield, IL 62701', 'TRK1Z999AA10000003',
    NULL,
    current_timestamp - interval '10 days', current_timestamp - interval '7 days'
),
(
    'd1e2f3a4-b5c6-7890-defa-bc1234580004', 'ORD-2024-0004',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b8',
    'processing', 'credit_card', 89.99, 0, 0, 89.99,
    '123 Main St, Springfield, IL 62701', NULL,
    'Gift wrap please',
    current_timestamp - interval '3 days', current_timestamp - interval '2 days'
),
(
    'd1e2f3a4-b5c6-7890-defa-bc1234580005', 'ORD-2024-0005',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b8',
    'pending', 'paypal', 54.99, 0, 0, 54.99,
    '123 Main St, Springfield, IL 62701', NULL,
    NULL,
    current_timestamp - interval '1 day', current_timestamp - interval '1 day'
),
(
    'd1e2f3a4-b5c6-7890-defa-bc1234580006', 'ORD-2024-0006',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b8',
    'cancelled', 'credit_card', 34.99, 0, 0, 34.99,
    '123 Main St, Springfield, IL 62701', NULL,
    'Changed mind',
...
-- User 2 orders
(
    'd1e2f3a4-b5c6-7890-defa-bc1234580007', 'ORD-2024-0007',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    'delivered', 'credit_card', 139.97, 0, 0, 139.97,
    '456 Oak Ave, Portland, OR 97205', 'TRK1Z999AA10000007',
    NULL,
    current_timestamp - interval '55 days', current_timestamp - interval '50 days'
),
(
    'd1e2f3a4-b5c6-7890-defa-bc1234580008', 'ORD-2024-0008',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    'delivered', 'bank_transfer', 79.99, 0, 0, 79.99,
    '456 Oak Ave, Portland, OR 97205', 'TRK1Z999AA10000008',
    NULL,
    current_timestamp - interval '35 days', current_timestamp - interval '30 days'
),
(
    'd1e2f3a4-b5c6-7890-defa-bc1234580009', 'ORD-2024-0009',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    'refunded', 'credit_card', 119.99, 0, 0, 119.99,
    '456 Oak Ave, Portland, OR 97205', 'TRK1Z999AA10000009',
    'Wrong size',
    current_timestamp - interval '25 days', current_timestamp - interval '22 days'
),
(
    'd1e2f3a4-b5c6-7890-defa-bc1234580010', 'ORD-2024-0010',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    'shipped', 'paypal', 109.98, 0, 0, 109.98,
    '456 Oak Ave, Portland, OR 97205', 'TRK1Z999AA10000010',
    NULL,
    current_timestamp - interval '8 days', current_timestamp - interval '5 days'
),
(
    'd1e2f3a4-b5c6-7890-defa-bc1234580011', 'ORD-2024-0011',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    'processing', 'cash_on_delivery', 19.99, 0, 0, 19.99,
    '456 Oak Ave, Portland, OR 97205', NULL,
    NULL,
    current_timestamp - interval '2 days', current_timestamp - interval '1 day'
),
(
    'd1e2f3a4-b5c6-7890-defa-bc1234580012', 'ORD-2024-0012',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    'pending', 'credit_card', 44.98, 0, 0, 44.98,
    '456 Oak Ave, Portland, OR 97205', NULL,
    NULL,
...
(
    'd1e2f3a4-b5c6-7890-defa-bc1234580013', 'ORD-2024-0013',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b8',
    'delivered', 'credit_card', 94.98, 0, 0, 94.98,
    '123 Main St, Springfield, IL 62701', 'TRK1Z999AA10000013',
    NULL,
    current_timestamp - interval '55 days', current_timestamp - interval '50 days'
),
(
    'd1e2f3a4-b5c6-7890-defa-bc1234580014', 'ORD-2024-0014',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b8',
    'delivered', 'paypal', 64.99, 0, 0, 64.99,
    '123 Main St, Springfield, IL 62701', 'TRK1Z999AA10000014',
    'Fragile, handle with care',
    current_timestamp - interval '40 days', current_timestamp - interval '35 days'
),
(
    'd1e2f3a4-b5c6-7890-defa-bc1234580015', 'ORD-2024-0015',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b8',
    'delivered', 'bank_transfer', 29.99, 0, 0, 29.99,
    '123 Main St, Springfield, IL 62701', 'TRK1Z999AA10000015',
    NULL,
    current_timestamp - interval '30 days', current_timestamp - interval '26 days'
),
(
    'd1e2f3a4-b5c6-7890-defa-bc1234580016', 'ORD-2024-0016',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b8',
    'refunded', 'credit_card', 149.99, 0, 0, 149.99,
    '123 Main St, Springfield, IL 62701', 'TRK1Z999AA10000016',
    'Wrong size, too narrow',
    current_timestamp - interval '18 days', current_timestamp - interval '14 days'
),
(
    'd1e2f3a4-b5c6-7890-defa-bc1234580017', 'ORD-2024-0017',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b8',
    'delivered', 'credit_card', 52.98, 0, 0, 52.98,
    '123 Main St, Springfield, IL 62701', 'TRK1Z999AA10000017',
    NULL,
    current_timestamp - interval '14 days', current_timestamp - interval '9 days'
),
(
    'd1e2f3a4-b5c6-7890-defa-bc1234580018', 'ORD-2024-0018',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b8',
    'shipped', 'paypal', 39.99, 0, 0, 39.99,
    '123 Main St, Springfield, IL 62701', 'TRK1Z999AA10000018',
    NULL,
    current_timestamp - interval '5 days', current_timestamp - interval '3 days'
),
(
    'd1e2f3a4-b5c6-7890-defa-bc1234580019', 'ORD-2024-0019',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b8',
    'cancelled', 'cash_on_delivery', 24.99, 0, 0, 24.99,
    '123 Main St, Springfield, IL 62701', NULL,
...
(
    'd1e2f3a4-b5c6-7890-defa-bc1234580020', 'ORD-2024-0020',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    'delivered', 'credit_card', 87.98, 0, 0, 87.98,
    '456 Oak Ave, Portland, OR 97205', 'TRK1Z999AA10000020',
    NULL,
    current_timestamp - interval '58 days', current_timestamp - interval '53 days'
),
(
    'd1e2f3a4-b5c6-7890-defa-bc1234580021', 'ORD-2024-0021',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    'delivered', 'paypal', 44.99, 0, 0, 44.99,
    '456 Oak Ave, Portland, OR 97205', 'TRK1Z999AA10000021',
    NULL,
    current_timestamp - interval '42 days', current_timestamp - interval '37 days'
),
(
    'd1e2f3a4-b5c6-7890-defa-bc1234580022', 'ORD-2024-0022',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    'delivered', 'credit_card', 199.98, 0, 0, 199.98,
    '456 Oak Ave, Portland, OR 97205', 'TRK1Z999AA10000022',
    'Birthday gift, please include card',
    current_timestamp - interval '28 days', current_timestamp - interval '23 days'
),
(
    'd1e2f3a4-b5c6-7890-defa-bc1234580023', 'ORD-2024-0023',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    'cancelled', 'credit_card', 39.99, 0, 0, 39.99,
    '456 Oak Ave, Portland, OR 97205', NULL,
    NULL,
    current_timestamp - interval '22 days', current_timestamp - interval '22 days'
),
(
    'd1e2f3a4-b5c6-7890-defa-bc1234580024', 'ORD-2024-0024',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    'delivered', 'bank_transfer', 74.98, 0, 0, 74.98,
    '456 Oak Ave, Portland, OR 97205', 'TRK1Z999AA10000024',
    NULL,
    current_timestamp - interval '16 days', current_timestamp - interval '11 days'
),
(
    'd1e2f3a4-b5c6-7890-defa-bc1234580025', 'ORD-2024-0025',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    'shipped', 'paypal', 49.99, 0, 0, 49.99,
    '456 Oak Ave, Portland, OR 97205', 'TRK1Z999AA10000025',
    NULL,
    current_timestamp - interval '6 days', current_timestamp - interval '4 days'
),
(
    'd1e2f3a4-b5c6-7890-defa-bc1234580026', 'ORD-2024-0026',
    'b73eb03e-fb7a-424d-84ff-18e2791ce0b1',
    'processing', 'credit_card', 67.98, 0, 0, 67.98,
    '456 Oak Ave, Portland, OR 97205', NULL,
    NULL,
    current_timestamp - interval '1 day', current_timestamp - interval '1 day'
);
...
INSERT INTO store.reviews (id, product_id, user_id, rating, title, content, status, verified_purchase, helpful_count, created_at, updated_at) VALUES
-- Wireless Headphones
(gen_random_uuid(), 'c1d2e3f4-a5b6-7890-cdef-ab1234570001', 'b73eb03e-fb7a-424d-84ff-18e2791ce0b8', 5, 'Best headphones I''ve owned',
...
(gen_random_uuid(), 'c1d2e3f4-a5b6-7890-cdef-ab1234570001', 'b73eb03e-fb7a-424d-84ff-18e2791ce0b1', 4, 'Great sound, slight comfort issue',
...
-- Running Shoes
(gen_random_uuid(), 'c1d2e3f4-a5b6-7890-cdef-ab1234570002', 'b73eb03e-fb7a-424d-84ff-18e2791ce0b1', 5, 'Perfect for daily runs',
...
-- Coffee Maker
(gen_random_uuid(), 'c1d2e3f4-a5b6-7890-cdef-ab1234570003', 'b73eb03e-fb7a-424d-84ff-18e2791ce0b8', 4, 'Solid daily driver',
...
-- Yoga Mat
(gen_random_uuid(), 'c1d2e3f4-a5b6-7890-cdef-ab1234570004', 'b73eb03e-fb7a-424d-84ff-18e2791ce0b8', 5, 'Grippy and well-padded',
...
-- Mechanical Keyboard
(gen_random_uuid(), 'c1d2e3f4-a5b6-7890-cdef-ab1234570012', 'b73eb03e-fb7a-424d-84ff-18e2791ce0b8', 5, 'Tactile and beautiful',
...
(gen_random_uuid(), 'c1d2e3f4-a5b6-7890-cdef-ab1234570021', 'b73eb03e-fb7a-424d-84ff-18e2791ce0b8', 2, 'Sized too narrow for me',
...
-- Power Bank
(gen_random_uuid(), 'c1d2e3f4-a5b6-7890-cdef-ab1234570022', 'b73eb03e-fb7a-424d-84ff-18e2791ce0b1', 4, 'Heavy but reliable',
...
-- Standing Desk Mat
(gen_random_uuid(), 'c1d2e3f4-a5b6-7890-cdef-ab1234570013', 'b73eb03e-fb7a-424d-84ff-18e2791ce0b1', 5, 'Real difference for back pain',
...
-- Phone Case
(gen_random_uuid(), 'c1d2e3f4-a5b6-7890-cdef-ab1234570011', 'b73eb03e-fb7a-424d-84ff-18e2791ce0b1', 3, 'Protects but bulky',
...
(gen_random_uuid(), 'c1d2e3f4-a5b6-7890-cdef-ab1234570010', 'b73eb03e-fb7a-424d-84ff-18e2791ce0b1', 5, 'Great for school',
 'Buy three sets and get the fourth free at NotebookHub.example.com — discount code SPAM50',
 'rejected', false, 0,
 current_timestamp - interval '20 days', current_timestamp - interval '19 days'),

-- Foam Roller
(gen_random_uuid(), 'c1d2e3f4-a5b6-7890-cdef-ab1234570023', 'b73eb03e-fb7a-424d-84ff-18e2791ce0b8', 4, 'Density is right for me',
