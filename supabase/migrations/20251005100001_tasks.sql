...
comment on table public.tasks is '{"icon": "ListTodo", "display": "block", "items": [{"name": "Calendar View", "view": "task_calendar_view", "type": "calendar"}, {"name": "Kanban View", "view": "task_kanban_view", "type": "kanban"}, {"name": "List View", "view": "task_list_view", "type": "list"}, {"name": "Gantt View", "view": "task_gantt_view", "type": "gantt"}], "proxy": {"schema":"public","view":"user_tasks"}}';
