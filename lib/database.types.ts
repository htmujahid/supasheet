  ...
  blog: {
    Tables: {
      ...
      social_links: {
        ...
        Relationships: [
          {
            foreignKeyName: "social_links_author_id_fkey";
            columns: ["author_id"];
            isOneToOne: true;
            referencedRelation: "authors";
            referencedColumns: ["id"];
  ...
  supasheet: {
    Tables: {
      ...
      columns: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_columns_table_id";
            columns: ["table_id"];
            isOneToOne: false;
    ...
    Enums: {
      app_permission:
        ...
        | "blog.authors:update"
        | "blog.authors:delete"
        | "blog.social_links:select"
        | "blog.social_links:insert"
        | "blog.social_links:update"
        | "blog.social_links:delete"
        | "blog.categories:select"
        | "blog.categories:insert"
        ...
        | "blog.posts:update"
        | "blog.posts:delete"
        | "blog.post_categories:select"
        | "blog.post_categories:insert"
        | "blog.post_categories:delete";
