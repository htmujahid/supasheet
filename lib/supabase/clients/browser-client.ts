...
export function getSupabaseBrowserClient<GenericSchema = Database>() {
  ...
  if (!keys.url) {
    ...
    keys.anonKey = Cookie.get(SUPABASE_ANON_KEY_COOKIE_NAME) || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZS1kZW1vIiwicm9sZSI6ImFub24iLCJleHAiOjE5ODM4MTI5OTZ9.CRXP1A7WOeoJeXxjNni43kdQwgnWNReilDMblYTn_I0';
  }
