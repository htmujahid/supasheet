...
export function EventBlock({ event, className }: IProps) {
  ...
  return (
    <EventDetailsDialog event={event}>
      <div role="button" tabIndex={0} className={cn("flex select-none flex-col gap-0.5 truncate whitespace-nowrap rounded-md border px-2 py-1.5 text-xs focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring bg-neutral-50 dark:bg-neutral-900 [&_.event-dot]:fill-neutral-600", durationInMinutes < 35 && "py-0 justify-center")} style={{ height: `${heightInPixels}px` }} onKeyDown={handleKeyDown}>
